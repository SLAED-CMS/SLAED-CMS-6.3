...
$content = $tpl->getHtmlFrag('table', ['headers' => [['text' => _FILES], ['text' => _PAGES], ['text' => _FAQ]], 'rows_html' => $tpl->getHtmlFrag('table-row', ['cells' => [['content_html' => $col1], ['content_html' => $col2], ['content_html' => $col3]]])]);
