...
const DEMO_VARIANTS = [
  ...
  },
  {
    ...
    mode: "dark",
    note: "Компоновка и сцены оригинала 00, обе левые панели, актуальная шапка и подвал SLAED. Сборки модулей, поиск раздела, день и ночь, сезоны и управление анимацией.",
    tags: ["19 · развитие эталона", "системная обвязка", "оригинальные сцены"],
  },
];
