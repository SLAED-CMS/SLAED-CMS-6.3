/* Gallery manifests and the shared chrome for the settings, upload and favorites series.
   Phoenix presentation variants use their own standalone presentation.css and presentation.js assets. */
...
const DEMO_VARIANTS = [
    ...
    {
        "file": "01-phoenix-command.html",
        "title": "Phoenix · Командный центр",
        "note": "ДНК лидера: синяя инженерная сетка, постоянный сайдбар, большой график и журнал событий.",
        "tags": [
            "01–06 · развитие лидера",
            "Phoenix"
        ]
    },
    {
        "file": "02-phoenix-observatory.html",
        "title": "Phoenix · Обсерватория",
        "note": "Горизонтальная навигация, широкая телеметрия, индикатор кэша и тепловая карта.",
        "tags": [
            "01–06 · развитие лидера",
            "Phoenix"
        ]
    ...
    {
        "file": "03-phoenix-studio.html",
        "title": "Phoenix · Студия модулей",
        "note": "Узкий рельс и асимметричный первый экран. Возможности представлены как рабочие пространства.",
        "tags": [
            "01–06 · развитие лидера",
            "Phoenix"
        ]
    ...
    {
        "file": "04-phoenix-ledger.html",
        "title": "Phoenix · Системный журнал",
        "note": "Навигация справа, строгие линейки, таблица модулей впереди графиков.",
        "tags": [
            "01–06 · развитие лидера",
            "Phoenix"
        ]
    ...
    {
        "file": "05-phoenix-flow.html",
        "title": "Phoenix · Поток",
        "note": "Путь запроса занимает всю ширину, ниже — время ответа и виджеты состояния.",
        "tags": [
            "01–06 · развитие лидера",
            "Phoenix"
        ]
    ...
    {
        "file": "06-phoenix-cockpit.html",
        "title": "Phoenix · Кокпит",
        "note": "Плотный пульт с тремя приборами, лаконичной навигацией и аналитикой под ними.",
        "tags": [
            "01–06 · развитие лидера",
            "Phoenix"
        ]
    },
    {
        ...
        "title": "RecehTok · Спектр",
        "note": "Фиолетовая глубина RecehTok, светящиеся линии, карточки показателей и кольцевая диаграмма.",
        "tags": [
            "07–18 · референсы",
            "RecehTok"
        ]
    ...
    {
        "file": "08-calltimes-orbit.html",
        "title": "Calltimes · Ритм",
        "note": "Спокойный лавандовый интерфейс: распределение активности, временные шкалы и календарь.",
        "tags": [
            "07–18 · референсы",
            "Calltimes"
        ]
    },
    {
        ...
        "title": "Vaulto · Карбон",
        "note": "Угольные поверхности и красный акцент: график, столбики, поток контента и матрица активности.",
        "tags": [
            "07–18 · референсы",
            "Vaulto"
        ]
    },
    {
        ...
        "title": "Hynex · Пульс системы",
        "note": "Три равноправные колонки, бирюзовые и лаймовые индикаторы, карточки состояния.",
        "tags": [
            "07–18 · референсы",
            "Hynex"
        ]
    },
    {
        ...
        "note": "Контент как библиотека: карточки направлений, прогресс, календарь и мягкая типографика.",
        "tags": [
            "07–18 · референсы",
            "Fobework"
        ]
    ...
    {
        "file": "12-analytics-prism.html",
        "title": "Analytics · Призма",
        "note": "Монохромный аналитический холст с крупным заголовком, большой диаграммой и тремя спутниками.",
        "tags": [
            "07–18 · референсы",
            "Analytics"
        ]
    },
    {
        ...
        "note": "Чёрный центр безопасности: сегментированный индикатор, прогнозная форма графика и журнал.",
        "tags": [
            "07–18 · референсы",
            "Cybersecurity"
        ]
    },
    {
        ...
        "title": "Rinesk · Лайм",
        "note": "Светлая шалфейная среда, лаймовые акценты, лёгкая типографика и горизонтальное меню.",
        "tags": [
            "07–18 · референсы",
            "Rinesk"
        ]
    },
    {
        ...
        "note": "Просторная синяя оболочка, увеличенная левая колонка и приборы разного масштаба.",
        "tags": [
            "07–18 · референсы",
            "Aeros"
        ]
    },
    {
        ...
        "title": "RecehTok · Экосистема",
        "note": "Вторая интерпретация RecehTok: каталог впереди, контрастные карточки и двухколоночная аналитика.",
        "tags": [
            "07–18 · референсы",
            "RecehTok"
        ]
    },
    {
        ...
        "note": "Вторая интерпретация Vaulto: редакционный журнал, тёплый акцент и навигация справа.",
        "tags": [
            "07–18 · референсы",
            "Vaulto"
        ]
    },
    {
        ...
        "note": "Вторая интерпретация Aeros: светлый широкий холст, крупные приборы и спокойные голубые поверхности.",
        "tags": [
            "07–18 · референсы",
            "Aeros"
        ]
