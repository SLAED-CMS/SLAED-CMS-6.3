/* Gallery manifests and the shared chrome for the settings, upload and favorites series. The presentation series
   carries its own engine in deck.css and deck.js; `mode` names the scheme a face was designed in, and the gallery
   opens it in that scheme until the visitor picks another. */

const DEMO_VARIANTS = [
  {
    file: "00-dashboard-layout.html",
    title: "Dashboard Layout · Оригинал",
    mode: "dark",
    note: "Ваш лидер. Сохранён без изменений как эталон для сравнения.",
    tags: ["00 · оригинал","эталон"],
  },
  {
    file: "01-command-deck.html",
    title: "Командный центр",
    mode: "dark",
    note: "Палитра и двухколонная сцена лидера, содержимое пересобрано в бенто приборов: широкий график трафика с периодами, реестр с поиском, суд запросов, шина PDO, маршрут кэша.",
    tags: ["01–06 · развитие лидера","бенто","сайдбар + дорога"],
  },
  {
    file: "02-observatory.html",
    title: "Обсерватория",
    mode: "dark",
    note: "Без сайдбара: липкие вкладки сверху, телеметрическая стена во весь первый экран, тепловая карта, три датчика, радар принципов и вертикальная хроника.",
    tags: ["01–06 · развитие лидера","телеметрия","вкладки"],
  },
  {
    file: "03-ledger.html",
    title: "Системный журнал",
    mode: "dark",
    note: "Таблицы впереди графиков: правый липкий столбец, линейки вместо свечения, табличные цифры, реестр на 16 строк с фильтрами, журнал решений защиты.",
    tags: ["01–06 · развитие лидера","таблицы","правый сайдбар"],
  },
  {
    file: "04-cockpit.html",
    title: "Кокпит",
    mode: "dark",
    note: "Плотный пульт: рельс иконок слева, телеметрия справа, три больших датчика над названием, стек-бары, шина PDO и маршрут кэша, бегущая строка снизу.",
    tags: ["01–06 · развитие лидера","приборы","два сайдбара"],
  },
  {
    file: "05-flow.html",
    title: "Поток",
    mode: "dark",
    note: "Одна широкая колонна: путь запроса как конвейер в первом экране, под ним стек-бары по классам, шина PDO, суд запросов во всю ширину, хроника коммитов.",
    tags: ["01–06 · развитие лидера","конвейер","одна колонна"],
  },
  {
    file: "06-studio.html",
    title: "Студия модулей",
    mode: "dark",
    note: "Модуль как рабочее пространство: рельс иконок, асимметричный первый экран с терминалом, шесть карточек модулей с мини-графиками, роутер позиций блоков.",
    tags: ["01–06 · развитие лидера","модули","рельс"],
  },
  {
    file: "07-recehtok-neon.html",
    title: "RecehTok · Неон",
    mode: "dark",
    note: "Крипто-панель: тёмный сайдбар, фиолетово-бирюзовый градиент, портфель трафика, модули как активы со спарклайнами, свечи времени ответа, watchlist и транзакции.",
    tags: ["07–18 · референсы","RecehTok","app-shell"],
  },
  {
    file: "08-calltimes-rhythm.html",
    title: "Calltimes · Ритм",
    mode: "light",
    note: "Мягкий лавандовый интерфейс: белый сайдбар, приветствие с округлыми пилюлями, горизонтальные полосы модулей, недельные столбики, календарь и список агентов.",
    tags: ["07–18 · референсы","Calltimes","светлая"],
  },
  {
    file: "09-vaulto-carbon.html",
    title: "Vaulto · Карбон",
    mode: "dark",
    note: "Угольные поверхности и красный акцент: только верхняя навигация, плата баланса с графиком, счета, кошельки-модули, пунктирная вторая серия, матрица активности.",
    tags: ["07–18 · референсы","Vaulto","верхняя навигация"],
  },
  {
    file: "10-hynex-vital.html",
    title: "Hynex · Vital",
    mode: "light",
    note: "Клиническая белизна с бирюзой и лаймом: три равные колонки — витальные кольца, пульс времени ответа, расписание релизов; ниже реестр и иммунная система.",
    tags: ["07–18 · референсы","Hynex","три колонки"],
  },
  {
    file: "11-fobework-campus.html",
    title: "Fobework · Кампус",
    mode: "dark",
    note: "Тёмный кампус с коралловым акцентом: курсы как разделы документации с прогрессом, стек-аналитика, таблица лидеров из внедрений, календарь заданий справа.",
    tags: ["07–18 · референсы","Fobework","правая колонка"],
  },
  {
    file: "12-odds-analytics.html",
    title: "Odds · Аналитика",
    mode: "dark",
    note: "Почти чёрный холст, неоновая зелень и золото: четыре больших показателя со спарклайнами, градиентный график, ставки по модулям, воронка, таблица лидеров.",
    tags: ["07–18 · референсы","Analytics","плитки"],
  },
  {
    file: "13-cyber-sentinel.html",
    title: "Cyber · Sentinel",
    mode: "dark",
    note: "Центр угроз: суд запросов в роли первого экрана, датчик уровня угрозы, терминал решений, радар типов атак, тепловая карта, уголки на карточках.",
    tags: ["07–18 · референсы","Cybersecurity","терминал"],
  },
  {
    file: "14-rinesk-lime.html",
    title: "Rinesk · Лайм",
    mode: "light",
    note: "Шалфейные поверхности, лаймовый акцент и чёрный текст: пилюльное меню, огромные показатели, очередь запросов, статус агентов-модулей, горизонтальная хроника.",
    tags: ["07–18 · референсы","Rinesk","светлая"],
  },
  {
    file: "15-aeros-atmosphere.html",
    title: "Aeros · Атмосфера",
    mode: "dark",
    note: "Просторная глубокая синева: увеличенная левая колонна с климатическим циферблатом и комнатами-модулями, справа приборы разного масштаба и расписание.",
    tags: ["07–18 · референсы","Aeros","широкая колонна"],
  },
  {
    file: "16-recehtok-exchange.html",
    title: "RecehTok · Биржа",
    mode: "dark",
    note: "Биржевое лицо: бегущая строка модулей, таблица рынков на 16 строк, стакан из двух журналов, свечи и глубина, золотой акцент, зелёные и красные тики.",
    tags: ["07–18 · референсы","RecehTok","таблица впереди"],
  },
  {
    file: "17-vaulto-editorial.html",
    title: "Vaulto · Редакция",
    mode: "light",
    note: "Тёплый светлый холст, серифные заголовки, линейки и римские номера разделов, красный акцент, хроника коммитов, журнальная сетка внедрений.",
    tags: ["07–18 · референсы","Vaulto","светлая · редакция"],
  },
  {
    file: "18-aeros-horizon.html",
    title: "Aeros · Горизонт",
    mode: "light",
    note: "Светлый широкий холст: три больших датчика под названием, пилюльная навигация, расписание, плитки и таблица модулей под переключателем, мягкие голубые поверхности.",
    tags: ["07–18 · референсы","Aeros","светлая · датчики"],
  },
  {
    file: "19-phoenix-laboratory.html",
    title: "Phoenix Laboratory · Восстановленный вариант",
    mode: "dark",
    note: "Восстановленная версия со снимка: три композиции, график «Ритм вашей системы», показатель 98,7%, реестр и интерактивная карта модулей.",
    tags: ["19 · восстановленный", "Performance Explorer", "три композиции"],
  },
  {
    file: "20-phoenix-laboratory.html",
    title: "Phoenix Laboratory · Рабочая область",
    mode: "auto",
    note: "Сцены эталона под верхним рельсом разделов и рабочей областью из четырёх карточек: график нагрузки, витальные показатели, реестр модулей и карточка контроля. Три композиции, командный диалог по Ctrl+K, панель среды.",
    tags: ["20 · развитие эталона", "рабочая область", "командный диалог"],
  },
  {
    file: "21-dashboard-layout.html",
    title: "Dashboard Layout · Эталон в системе",
    mode: "dark",
    note: "Прежний вариант 19 под номером 21: компоновка и сцены оригинала 00, обе левые панели, актуальная шапка и подвал SLAED. Сборки модулей, поиск раздела, темы и сезоны.",
    tags: ["21 · развитие эталона", "системная обвязка", "оригинальные сцены"],
  },
  {
    file: "22-dashboard-layout-etalon.html",
    title: "Dashboard Layout · Эталон",
    mode: "dark",
    note: "Эталон перед внедрением: обе левые колонки сняты, кокпит с гейджами и световым лучом в верхнем блоке, отделы едут горизонтальным липким рельсом, отдел 01 — график нагрузки и витальные показатели ядра. Свет идёт за курсором по каждой поверхности.",
    tags: ["22 · эталон", "точка отсчёта", "компоновка"],
  },
];
...
/* The fifth series: the first screen of the administrator, `admin.php`. The live page gives thirty-eight modules one
   tile and one weight and spends a sidebar on queues that are mostly empty; four faces ask what the page is for and
   the fifth merges the leaders.
   They stand on the admin theme and share one corpus and one engine, `assets/admin.css` and `assets/admin.js`. */
const DEMO_ADMIN = [
  {
    file: 'adm-01-focus.html',
    title: 'Фокус',
    note: 'Панель перестаёт быть каталогом. Первый экран отвечает на три вопроса по порядку: что ждёт меня сейчас — пять очередей крупными цифрами, ' +
      'пустые девять названы одной строкой; куда я хожу чаще всего — восемь закреплённых модулей; где всё остальное — 38 текстовых ссылок в пяти группах по смыслу. Сайдбара ' +
      'нет, модуль подаёт сигнал только когда отличается: чип очереди или замок доступа.',
    tags: ['без сайдбара', 'очереди', 'закреплённые', 'группы по смыслу'],
  },
  {
    file: 'adm-02-rail.html',
    title: 'Рельс',
    note: 'Оболочка приложения в три панели: рельс из шести мест, список выбранного места и инспектор. На экране никогда не больше двенадцати модулей, ' +
      'у каждого — одно предложение о том, что он делает. Веер из трёх точек раскрыт в инспекторе именованными действиями, статус — настоящий переключатель темы.',
    tags: ['app-shell', 'мастер-деталь', 'инспектор', 'sl-radio-switch'],
  },
  {
    file: 'adm-03-launcher.html',
    title: 'Лаунчер',
    note: 'Панель как домашний экран: первым стоит поле поиска, под ним модули — иконка, имя и бейдж, ' +
      'когда что-то ждёт. Тринадцать строк сайдбара растворяются в трёх бейджах на иконках. Описание модуля говорит строка-подсказка внизу — для одного модуля под курсором, ' +
      'а не для всех сразу. «/» или Ctrl+K — в поиск, Enter — открыть первый найденный.',
    tags: ['поиск первым', 'бейджи', 'клавиатура', 'строка-подсказка'],
  },
  {
    file: 'adm-04-cockpit.html',
    title: 'Кокпит',
    note: 'Лицо презентационной страницы, принесённое домой: пять приборов, окно журнала, ' +
      'маршрут запроса. Все эти цифры у живой панели уже есть — они лежат под подвалом четырьмя зелёными полосами. Здесь они на первом экране, ' +
      'а модули стали коммутатором из маленьких клавиш в пяти отсеках, размер отсека — по содержимому.',
    tags: ['бенто', 'приборы', 'журнал', 'клавиши'],
  },
  {
    file: 'adm-05-bridge.html',
    title: 'Мостик',
    note: 'Слияние лидеров. Скелет и порядок вопросов — «Фокуса»: что ждёт, куда хожу чаще всего, где всё остальное. Приборы «Кокпита» стоят рядом с приветствием, ' +
      'так что состояние системы читается тем же взглядом. Инспектор «Рельса» занял правую колонку: название открывает модуль одним кликом, как сегодня, ' +
      'а три точки вместо веера показывают модуль в инспекторе — именованные действия и переключатель статуса, которые ничего не закрывают.',
    tags: ['слияние', 'очереди', 'приборы', 'инспектор'],
  },
  {
    file: 'adm-06-leader.html',
    title: 'Лидер',
    mode: 'dark',
    note: 'Живая страница как есть, на языке презентации. Ни один элемент не добавлен, не сдвинут и не убран — это разметка, которую отдаёт admin.php, ' +
      'со скриптами темы: панели сворачиваются, веер раскрывается, окно опций открывается. Оформление прочитано с presentation.css: линованный грунт и кольца угла, ' +
      'блоки сайдбара — окна с тремя лампами в шапке, моноширинные капс-подписи, заголовок раздела — номер в рамке, иконка в рамке и название над линейкой, ' +
      'плитка — карточка технологий с тонированным глифом и линией света по наведению, счётчик — цифра в рамке, скан-линия в шапке. Тёмная схема — глубокий синий лидера.',
    tags: ['структура 1:1', 'язык презентации', 'окна', 'моно-подписи'],
  },
  {
    file: 'adm-07-effects.html',
    title: 'Эффекты',
    note: 'Оригинал один в один и слой движения поверх. Ни цвет, ни градиент, ни шрифт, ни размер темы не изменены, ' +
      'разметка — исходник admin.php со скриптами темы. Страница появляется, блоки сайдбара въезжают, ' +
      'плитки поднимаются каскадом — и снова при разворачивании раздела. За курсором идёт мягкий свет; плитка под рукой наклоняется к курсору, несёт блик и свет, ' +
      'бегущий по рамке, её иконка подпрыгивает, а бокс заливается тоном. По сплошным полосам заголовков проходит блик, клик даёт рябь, счётчики сайдбара набегают, ' +
      'непустой счётчик несёт маячок, полосы отладки наполняются с бегущими штрихами. Всё стоит под prefers-reduced-motion и выключателем движения стенда.',
    tags: ['оригинал 1:1', 'только эффекты', 'наклон и блик', 'каскад', 'рябь'],
  },
];
