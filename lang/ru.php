...
define('_EMODEEMBEDINFO','Изображение кодируется в base64 и сохраняется прямо в тексте. Только для небольших изображений.');
...
define('_EDITOR_LINKNOTE','Внешний адрес, ничего не хранится');
