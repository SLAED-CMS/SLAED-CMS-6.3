...
define('_ERROR_PAGE','Произошла ошибка %1$s. Запрашиваемая страница недоступна или не существует. Возможно, вы перешли по устаревшей ссылке, ошиблись адресом, либо произошла ошибка на сервере. Сейчас вы будете перенаправлены на главную страницу сайта.');
