...
define('_EINSOBJINFO','Для изображения будет вставлена миниатюра с открытием оригинала в модальном окне. Для других файлов — представление, настроенное для типа файла.');
