...
define('_CONFIRM','Подтверждение');
define('_COPIED','Ссылка скопирована');
define('_COPYLINK','Копировать ссылку');
define('_CODE','Код');
...
define('_DEBUGPANEL','Панель диагностики');
...
define('_ERROR_PAGE','Произошла ошибка %1$s. Запрашиваемая страница недоступна или не существует. Возможно, вы перешли по устаревшей ссылке, ошиблись адресом, либо произошла ошибка на сервере. Вернитесь на главную страницу или воспользуйтесь поиском.');
...
define('_ERRLOG','Ошибки и предупреждения');
define('_ERROR_PASS','Введённые пароли не совпадают!');
define('_ERROR_SERV','Файл этого типа сейчас не может быть обработан на сервере!');
...
define('_EATTACH','Вложение');
define('_EDROPFILES','Перетащите файлы сюда или нажмите на поле');
define('_EEMOJI','Смайлы');
define('_EEMOJIEMPTY','Нет эмодзи');
define('_EEMOJINOTICE','Заметки');
define('_EEMOJIREACT','Реакции');
define('_EEMOJIRECENT','Недавние');
define('_EEMOJISMILE','Смайлы');
define('_EEMOJISYMBOL','Символы');
define('_EEXITFULL','Выйти из полноэкранного режима');
define('_EEXPAND','Развернуть окно');
define('_EFULLSCREEN','Развернуть редактор на весь экран');
define('_EIMGURL','Адрес изображения');
define('_EINSOBJ','Вставить миниатюру или файл');
define('_EMODEEMBED','Встроить в текст');
define('_EMODEEMBEDINFO','Файл кодируется в base64 и сохраняется в тексте. Только для небольших изображений.');
define('_EMODEUPLOAD','Загрузить на сервер');
define('_EMODEUPLOADINFO','Файлы будут загружены на сервер. Отметьте нужные и нажмите «Вставить».');
define('_EMOVEWIN','Переместить окно');
define('_ENOEMBED','Это поле не может хранить встроенное изображение — вставьте его по ссылке.');
define('_ENOFILE','Файл не выбран');
define('_ERESTORE','Восстановить окно');
define('_ETABS','Вкладки');
define('_ETEXTLONG','Текст длиннее, чем вмещает это поле — не более %s.');
...
define('_EDITOR_LINKINFO','Изображение подключается по внешнему адресу, на сервер ничего не попадает.');
define('_EDITOR_LINKWARN','Файл остаётся на чужом сервере. В квоту модуля он не входит, но и сохранность его не гарантируется.');
define('_EDITOR_MY','Мои файлы');
define('_EDITOR_MYNOTE','Файлов в модуле: %d');
define('_EDITOR_MYINFO','Уже загруженные файлы модуля. Действия — в меню файла, предпросмотр — по нажатию на картинку.');
define('_EDITOR_NOUP','Группе не разрешена загрузка файлов');
define('_EDITOR_NOMY','Каталог доступен только вместе с правом загрузки');
define('_EDITOR_EMPTY','Каталог пока пуст');
define('_EDITOR_EMPTYWHY','Загруженные файлы появятся здесь сразу после первой загрузки.');
define('_EDITOR_NONE','Ничего не найдено');
define('_EDITOR_NONEWHY','В этой директории нет файлов, подходящих под фильтр.');
define('_EDITOR_FAIL','Список не загрузился');
define('_EDITOR_FAILWHY','Сервер не ответил на запрос каталога. Файлы на месте, получить список не удалось.');
define('_EDITOR_WAIT','Каталог загружается');
define('_EDITOR_FILTER','Фильтр по имени в этой директории');
define('_EDITOR_IMAGES','Картинки');
define('_EDITOR_ASLIST','Списком');
define('_EDITOR_ASGRID','Плитками');
define('_EDITOR_FULL','Открыть весь каталог');
define('_EDITOR_OTHERS','Файлы');
define('_EDITOR_PROPS','Свойства файла');
define('_EDITOR_NOTE','Показан относительный адрес внутри разрешённой директории модуля. Абсолютный путь на сервере в окно не передаётся.');
define('_EDITOR_DIM','Разрешение');
define('_EDITOR_PERMS','Права доступа');
define('_EDITOR_OWNER','Владелец');
define('_EDITOR_ADDR','Адрес');
define('_EDITOR_MARK','Отметить');
define('_EDITOR_MARKALL','Отметить все файлы');
define('_EDITOR_MARKED','Отмечено');
define('_EDITOR_INSAS','Вставить как');
define('_EDITOR_INSERT','Вставить');
define('_EDITOR_OPTS','Параметры вставки');
define('_EDITOR_ALIGN','Обтекание текстом');
define('_EDITOR_ALIGNNO','Без обтекания');
define('_EDITOR_ALIGNLEFT','Слева от текста');
define('_EDITOR_ALIGNRIGHT','Справа от текста');
define('_EDITOR_CAPTION','Подпись');
define('_EDITOR_INSIMGS','Вставить изображениями');
define('_EDITOR_INSOBJS','Вставить вложениями');
define('_EDITOR_UNMARK','Снять отметки');
define('_EDITOR_ZIP','Сжать в ZIP');
define('_EDITOR_ASKDEL','Удалить файл %s?');
define('_EDITOR_ASKDELS','Удалить отмеченные файлы: %d?');
define('_EDITOR_QUEUE','Загружается файл %1$d из %2$d');
define('_EDITOR_QUEUEEND','Загружено файлов: %1$d из %2$d');
define('_EDITOR_STOP','Отменить загрузку');
define('_EDITOR_USED','Занято в модуле');
define('_EDITOR_ROOM','Место в записи');
define('_EDITOR_MODULE','Модуль: %s');
define('_EDITOR_MORE','Показаны %1$d последних файлов из %2$d.');
define('_EDITOR_PREV','Предыдущий');
define('_EDITOR_NEXT','Следующий');
...
define('_FAVOR_DONE','Добавлено в фавориты');
define('_FAVOR_MODS','Модулей');
define('_FAVOR_TOP','Больше всего');
define('_FAVOR_LAST','Последняя');
define('_FAVOR_FOLD','Нажмите на заголовок полки, чтобы свернуть или развернуть материалы.');
define('_FAVOR_FREE','Свободно %1$s из %2$s');
define('_FAVOR_SEEK','Найти среди фаворитов');
define('_FAVOR_SEEKNOTE','Название материала или модуль');
define('_FAVOR_NONE','Ничего не найдено. Сотрите запрос или выберите модуль чипом выше.');
define('_FEEDBACK','Обратная связь');
define('_FIELDS_REQ','Это поле обязательно к заполнению.');
define('_FIELDS_TYPE','Значение имеет неверную структуру.');
define('_FIELDS_FORMAT','Значение имеет неверный формат.');
define('_FIELDS_CHOICE','Значение не входит в список допустимых вариантов.');
define('_FIELDS_MIN','Значение меньше допустимого минимума.');
define('_FIELDS_MAX','Значение больше допустимого максимума.');
define('_FILE','Файл');
...
define('_FRESET','Сбросить фильтр');
define('_FROM','Из');
...
define('_MEMUSAGE','Использование и объём памяти');
define('_DBQUERY','Всего запросов к базе данных');
define('_DBQTIME','Время запросов к базе данных');
...
define('_MIN','мин');
define('_MODE_AUTO','Системная');
define('_MODE_LIGHT','Светлая');
define('_MODE_DARK','Тёмная');
...
define('_MODULES_DUPLICATE','Найдены дублирующиеся модули');
define('_MODULES_NEW','Найдены новые модули');
define('_MODULES_DELETED','Модули удалены');
define('_MORE','Ещё');
define('_NAME','Название');
define('_NEW','Новые');
define('_NEWLAST3DAYS','Добавлен за последние 3 дня');
define('_NEWMONTH','Добавлено в этом месяце');
define('_NEWNOW','Только что опубликовано');
...
define('_NODE_CAST','Участники');
define('_NODE_COVER','Обложка');
define('_NODE_CREATOR','Создатель');
define('_NODE_DIRECTOR','Режиссёр');
define('_NODE_MFORMAT','Формат');
define('_NODE_PLAY','Воспроизведение');
define('_NODE_POSTER','Заставка');
define('_NODE_QUALITY','Качество');
define('_NODE_RELEASE','Выпуск');
define('_NODE_RUNTIME','Продолжительность');
define('_NODE_SUBTITLE','Дополнительное название');
define('_NODE_YEAR','Год');
define('_NONE','Нет');
define('_NOPASS','Вы не указали и не повторили пароль!');
define('_NOTE','Примечание');
define('_NO_INFO','Нет информации');
define('_NUMOF','%1$s из %2$s');
define('_OAUTHWITH','Войти через');
...
define('_PLOAD1','Данная опция замедляет работу системы от одной до двух секунд!');
define('_POINTS','Пункты');
define('_POINTS_PUBLISH','Публикация материала или темы');
define('_POINTS_COMMENT','Комментарий или ответ');
define('_POINTS_VIEW','Засчитанный просмотр');
define('_POINTS_DOWNLOAD','Засчитанное скачивание');
define('_POINTS_VISIT','Засчитанный переход по внешней ссылке');
define('_POINTS_POLL','Голос в опросе');
define('_POINTS_ORDER','Подтверждённый заказ');
define('_POINTS_FAVORITE','Добавление в избранное');
define('_POINTS_MESSAGE','Сообщение или обращение');
define('_POINTS_RECOMMEND','Рекомендация сайта');
define('_POINTS_REGISTER','Регистрация');
define('_POINTS_LOGIN','Засчитанный вход');
define('_POINTS_REPORT','Подтверждённая полезная жалоба');
define('_POINTS_MODERATE','Завершённое действие модератора');
define('_POINTS_ADJUST','Корректировка администратором');
define('_POINTS_PERIOD','Период, сек.');
define('_POINTS_LIMIT','Наград за период');
...
define('_PRBACK','К списку');
define('_PRBOXFULL','Ящик полон');
define('_PRBOXNEAR','Ящик почти полон');
define('_PRBOXROOM','В ящике есть место');
define('_PRBYMATE','По собеседнику');
define('_PRBYNEW','Сначала новые');
define('_PRBYOLD','Сначала старые');
define('_PRBYUNS','Непрочитанные сверху');
define('_PRESENTATION','Презентация');
define('_PREVIEW','Предварительный просмотр');
define('_PRFILLED','%1$s заполнены на %2$s процентов');
define('_PRFILTER','Фильтр');
define('_PRFOCUS','Фокус');
define('_PRFOCUSN','%1$s непрочитанных');
define('_PRFORWARD','Переслать');
define('_PRFOUND','Найдено %1$s из %2$s');
define('_PRFREE','Свободно %1$s');
define('_PRFRESH','За неделю');
define('_PRFWD','Пересылка');
...
define('_PRIVAT_DELIN','Удалено получателем');
define('_PRIVAT_DELOUT','Удалено отправителем');
define('_PRIVAT_NEW','Отметить непрочитанными');
define('_PRIVAT_NOSEL','Выберите сообщения, к которым применяется действие.');
define('_PRIVAT_READ','Отметить прочитанными');
define('_PRIVAT_UNSAVE','Убрать из сохранённых');
define('_PRLIMSUB','Заголовок, до %1$s символов');
define('_PRLIMTO','Имя, до %1$s символов');
define('_PRLIST','Список сообщений');
...
define('_PRNOHIT','Под фильтры не попало ни одного письма');
define('_PRNOLIMIT','Без ограничения');
...
define('_PRPICK','Письмо не выбрано');
define('_PRPICKT','Выберите сообщение слева, чтобы прочитать его и ответить. Открытие входящего сразу помечает его прочитанным.');
define('_PRRE','Получатель');
define('_PRREP','Ответ');
define('_PRRESET','Сбросить всё');
...
define('_PRSEEK','Поиск по теме, тексту и автору');
define('_PRSEEN','Прочитанные');
...
define('_PRSORT','Сортировка');
define('_PRSTALE','Старше месяца');
define('_PRUNSEEN','Непрочитанные');
define('_PRVIEW','Просмотр сообщения');
define('_PRWAIT','Интервал %1$s сек.');
define('_PRWIPE','Очистить форму');
define('_PRWRITE','Написать');
...
define('_RATINGS_FORM','Неверные параметры оценки.');
define('_RATINGS_DENY','Оценка недоступна: рейтинг выключен, закрыт для гостей или это ваш собственный материал.');
define('_RATINGS_GONE','Объект оценки не найден.');
define('_RATINGS_TWICE','Этот запрос уже принят с другой оценкой.');
define('_RATINGS_WAIT','Вы уже оценивали. Дней до следующей оценки: %d');
define('_RATINGS_FAIL','Оценка не сохранена, повторите попытку.');
...
define('_SEC','сек');
define('_SECCODEINCOR','Не пройден алгоритм проверки на реального пользователя, пожалуйста обратитесь к администрации проекта!');
define('_SECURITY','Безопасность');
define('_SHARE','Поделиться');
...
define('_SUM','Сумма');
define('_SYSTEM_INFO','Производительность системы');
...
define('_UPDATED','Обновлено');
define('_URANK','Звание');
define('_URL','Ссылка');
define('_USER','Пользователь');
define('_USERDEL','Пользователь удалён');
...
define('_TPLMISS','Ошибка подключения шаблона! Указанный в функции шаблон отсутствует в директории темы оформления: %1$s. Рекомендуем создать файл с соответствующим названием: %2$s.html');
define('_VIEW','Кто видит');
define('_VIEWS','Пр.');
define('_VOPEN','Открытый опрос');
define('_VOTE','Голосовать');
define('_VOTES','Голосов');
define('_VOTING_ACT','Идёт голосование');
define('_VOTING_END','Голосование завершено');
...
define('_ERR_TYPE','Неподдерживаемый тип источника');
define('_ERR_ZIPNA','ZIP недоступен');
define('_ERR_ZOPEN','Не удалось открыть ZIP');
define('_ERR_ZADD','Не удалось добавить в ZIP');
define('_ERR_READ','Ошибка чтения');
define('_ERR_WRITE','Ошибка записи');
define('_ERR_DELETE','Ошибка удаления');
define('_ERR_NOCOMP','Нет доступного метода сжатия');
define('_ERR_INVMODE','Неверный режим сжатия');
define('_ERR_GZNA','GZIP недоступен');
define('_ERR_BZ2NA','BZIP2 недоступен');
define('_ERR_DIR','Целевой каталог не найден');
define('_ERR_PARAM','Отсутствует источник или имя архива');
define('_ERR_FILE','Источник должен быть файлом для gzip/bzip2');
define('_ERR_OPEN','Не удается открыть исходный файл');
define('_ERR_GZIP','Не удается создать gzip-архив');
define('_ERR_BZIP','Не удается создать bzip2-архив');

# Captcha widget (ALTCHA)
define('_CAPTCHA_LABEL','Я не робот');
define('_CAPTCHA_VERIFYING','Проверка…');
define('_CAPTCHA_VERIFIED','Проверка завершена успешно!');
define('_CAPTCHA_ERROR','Проверка не пройдена. Повторите попытку.');
define('_CAPTCHA_EXPIRED','Срок проверки истёк. Подтвердите снова.');
define('_CAPTCHA_LOADING','Загрузка…');
define('_CAPTCHA_REQUIRED','Требуется проверка!');
define('_CAPTCHA_WAIT','Идёт проверка… пожалуйста, подождите.');
