...
define('_EINSOBJINFO','Une image est insérée comme miniature ouvrant l’original dans une fenêtre modale. Les autres fichiers utilisent la présentation configurée pour leur type.');
...
define('_ESELFILE','Choisir un fichier');
