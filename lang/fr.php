...
define('_COPIED','Lien copié');
define('_COPYLINK','Copier le lien');
define('_CODE','Code');
define('_COMMENT','Commentaire');
define('_COMMENTREPLY','Poster un commentaire');
define('_COMMENTS','Commentaires');
define('_COMMENTS_ADDED','Votre commentaire a été publié. Il se trouve sur une autre page de la discussion.');
define('_COMMENTS_REPLIES','Afficher les réponses');
define('_COMMENTS_REPS','Réponses affichées sous un commentaire');
define('_COMMENTS_MORE','Afficher plus de commentaires');
define('_COMMENTS_GONE','Ce commentaire a été supprimé. Les réponses en dessous sont conservées.');
define('_COMMENTS_PARENT','Cette réponse ne peut pas être rattachée au commentaire indiqué.');
define('_COMMENTS_REPLAY','Un commentaire est déjà enregistré sous cette clé et diffère de cette requête.');
define('_COMMENTS_EDITED','Modifié');
define('_COMMENTS_REPLY','Répondre');
...
define('_DEBUGPANEL','Panneau de diagnostic');
...
define('_ERROR_PAGE',"Erreur %1\$s survenue. La page demandée est indisponible ou n'existe pas. Vous avez peut-être suivi un lien obsolète, saisi une mauvaise adresse, ou une erreur serveur s'est produite. Revenez à la page d'accueil ou utilisez la recherche.");
...
define('_EDROPFILES','Déposez les fichiers ici ou cliquez sur le champ');
define('_EEMOJI','Emoji');
define('_EEMOJIEMPTY','Aucun emoji');
define('_EEMOJINOTICE','Notes');
define('_EEMOJIREACT','Reactions');
define('_EEMOJIRECENT','Recents');
define('_EEMOJISMILE','Smileys');
define('_EEMOJISYMBOL','Symboles');
define('_EEXITFULL','Quitter le plein écran');
define('_EEXPAND','Agrandir la fenêtre');
define('_EFULLSCREEN','Afficher l’éditeur en plein écran');
define('_EIMGURL','Adresse de l\'image');
define('_EINSOBJ','Insérer une miniature ou un fichier');
define('_EMODEEMBED','Intégrer dans le texte');
define('_EMODEEMBEDINFO','L\'image est enregistrée en Base64 directement dans le texte. Uniquement pour de petites images.');
define('_EMODEUPLOAD','Téléverser sur le serveur');
define('_EMODEUPLOADINFO','Les fichiers sont téléversés sur le serveur. Cochez ceux à insérer et cliquez sur «Insérer».');
define('_EMOVEWIN','Déplacer la fenêtre');
define('_ENOEMBED','Ce champ ne peut pas contenir d\'image intégrée — insérez-la par son adresse.');
define('_ENOFILE','Aucun fichier');
define('_ERESTORE','Restaurer la fenêtre');
define('_ETABS','Onglets');
define('_ETEXTLONG','Le texte est plus long que ce champ ne peut contenir — %s au maximum.');
...
define('_EDITOR_MYNOTE','Fichiers dans le module : %d');
define('_EDITOR_MYINFO','Fichiers déjà chargés du module. Les actions sont dans le menu du fichier, l\'aperçu s\'ouvre par son image.');
define('_EDITOR_NOUP','Le chargement de fichiers n\'est pas autorisé pour ce groupe');
define('_EDITOR_NOMY','Le catalogue ne s\'ouvre qu\'avec le droit de chargement');
define('_EDITOR_EMPTY','Le catalogue est encore vide');
define('_EDITOR_EMPTYWHY','Les fichiers chargés apparaissent ici dès le premier chargement.');
define('_EDITOR_NONE','Rien trouvé');
define('_EDITOR_NONEWHY','Aucun fichier de ce répertoire ne correspond au filtre.');
define('_EDITOR_FAIL','La liste n\'est pas arrivée');
define('_EDITOR_FAILWHY','Le serveur n\'a pas répondu à la demande du catalogue. Les fichiers sont en place, la liste n\'a pas pu être lue.');
define('_EDITOR_WAIT','Le catalogue se charge');
define('_EDITOR_FILTER','Filtre par nom dans ce répertoire');
define('_EDITOR_IMAGES','Images');
define('_EDITOR_ASLIST','En liste');
define('_EDITOR_ASGRID','En tuiles');
define('_EDITOR_FULL','Ouvrir tout le catalogue');
define('_EDITOR_OTHERS','Fichiers');
define('_EDITOR_PROPS','Propriétés du fichier');
define('_EDITOR_NOTE','L\'adresse affichée est relative au répertoire autorisé du module. Le chemin absolu du serveur n\'atteint jamais cette fenêtre.');
define('_EDITOR_DIM','Résolution');
define('_EDITOR_PERMS','Droits d’accès');
define('_EDITOR_OWNER','Propriétaire');
define('_EDITOR_ADDR','Adresse');
define('_EDITOR_MARK','Marquer');
define('_EDITOR_MARKALL','Marquer tous les fichiers');
define('_EDITOR_MARKED','Marqués');
define('_EDITOR_INSAS','Insérer comme');
define('_EDITOR_INSERT','Insérer');
define('_EDITOR_OPTS','Options d’insertion');
define('_EDITOR_ALIGN','Habillage du texte');
define('_EDITOR_ALIGNNO','Sans habillage');
define('_EDITOR_ALIGNLEFT','À gauche du texte');
define('_EDITOR_ALIGNRIGHT','À droite du texte');
define('_EDITOR_CAPTION','Légende');
define('_EDITOR_INSIMGS','Insérer comme images');
define('_EDITOR_INSOBJS','Insérer comme pièces jointes');
define('_EDITOR_UNMARK','Retirer les marques');
define('_EDITOR_ZIP','Compresser en ZIP');
define('_EDITOR_ASKDEL','Supprimer le fichier %s ?');
define('_EDITOR_ASKDELS','Supprimer les fichiers marqués : %d ?');
define('_EDITOR_QUEUE','Chargement du fichier %1$d sur %2$d');
define('_EDITOR_QUEUEEND','Fichiers chargés : %1$d sur %2$d');
define('_EDITOR_STOP','Annuler le chargement');
define('_EDITOR_USED','Occupé dans le module');
define('_EDITOR_ROOM','Place dans l\'enregistrement');
define('_EDITOR_MODULE','Module : %s');
define('_EDITOR_MORE','Les %1$d derniers fichiers sur %2$d sont affichés.');
define('_EDITOR_PREV','Précédent');
define('_EDITOR_NEXT','Suivant');
...
define('_FAVOR_DONE','Ajouté aux favoris');
define('_FAVOR_MODS','Modules');
define('_FAVOR_TOP','Le plus');
define('_FAVOR_LAST','Dernier');
define('_FAVOR_FOLD','Cliquez sur l\'en-tête d\'une étagère pour replier ou déplier ses éléments.');
define('_FAVOR_FREE','Libre %1$s sur %2$s');
define('_FAVOR_SEEK','Chercher dans les favoris');
define('_FAVOR_SEEKNOTE','Titre ou module');
define('_FAVOR_NONE','Rien trouvé. Effacez la requête ou choisissez un module ci-dessus.');
define('_FEEDBACK','Feedback');
define('_FIELDS_REQ','Ce champ doit être rempli.');
define('_FIELDS_TYPE','La valeur a une structure incorrecte.');
define('_FIELDS_FORMAT','La valeur a un format incorrect.');
define('_FIELDS_CHOICE','La valeur ne fait pas partie des options autorisées.');
define('_FIELDS_MIN','La valeur est inférieure au minimum autorisé.');
define('_FIELDS_MAX','La valeur est supérieure au maximum autorisé.');
...
define('_FRESET','Réinitialiser le filtre');
...
define('_PAGETIME','Temps de génération de la page');
define('_GERMAN','Allemand');
define('_GOBACK','<input type="button" value="en Arrière" class="sl_but_blue" OnClick="javascript:window.history.go(-1);">');
...
define('_INSERTIMG','Insérer une image');
...
define('_MEMUSAGE','Utilisation et limite de la mémoire');
define('_DBQUERY','Nombre total de requêtes à la base de données');
define('_DBQTIME','Temps des requêtes à la base de données');
...
define('_NEWMONTH','Ajouté ce mois-ci');
define('_NEWNOW','Publié à l\'instant');
...
define('_NODE_CAST','Distribution');
define('_NODE_COVER','Couverture');
define('_NODE_CREATOR','Créateur');
define('_NODE_DIRECTOR','Réalisateur');
define('_NODE_MFORMAT','Format');
define('_NODE_PLAY','Lecture');
define('_NODE_POSTER','Affiche');
define('_NODE_QUALITY','Qualité');
define('_NODE_RELEASE','Édition');
define('_NODE_RUNTIME','Durée');
define('_NODE_SUBTITLE','Titre secondaire');
define('_NODE_YEAR','Année');
define('_NONE','Non');
...
define('_NUMOF','%1$s sur %2$s');
define('_OAUTHWITH','Se connecter via');
define('_OCCUPATION','Profession');
define('_OK','OK');
define('_OFFLINE','Hors ligne');
define('_ONLINE','En ligne');
define('_ONLINE_NOW','En ligne maintenant');
...
define('_PLOAD1',"Cette option ralentit le système d'une à deux secondes!");
define('_POINTS','Points');
define('_POINTS_PUBLISH','Publication d\'un contenu ou d\'un sujet');
define('_POINTS_COMMENT','Commentaire ou réponse');
define('_POINTS_VIEW','Consultation comptée');
define('_POINTS_DOWNLOAD','Téléchargement compté');
define('_POINTS_VISIT','Visite comptée d\'un lien externe');
define('_POINTS_POLL','Vote dans un sondage');
define('_POINTS_ORDER','Commande confirmée');
define('_POINTS_FAVORITE','Ajout aux favoris');
define('_POINTS_MESSAGE','Message ou demande');
define('_POINTS_RECOMMEND','Recommandation du site');
define('_POINTS_REGISTER','Inscription');
define('_POINTS_LOGIN','Connexion comptée');
define('_POINTS_REPORT','Signalement utile confirmé');
define('_POINTS_MODERATE','Action de modérateur terminée');
define('_POINTS_ADJUST','Correction par un administrateur');
define('_POINTS_PERIOD','Période, s');
define('_POINTS_LIMIT','Récompenses par période');
...
define('_PRBACK','Retour à la liste');
define('_PRBOXFULL','Boîte pleine');
define('_PRBOXNEAR','Boîte presque pleine');
define('_PRBOXROOM','Place dans la boîte');
define('_PRBYMATE','Par correspondant');
define('_PRBYNEW','Les plus récents');
define('_PRBYOLD','Les plus anciens');
define('_PRBYUNS',"Non lus d'abord");
define('_PRESENTATION','Présentation');
define('_PREVIEW','Aperçu');
define('_PRFILLED','%1$s rempli à %2$s pour cent');
define('_PRFILTER','Filtre');
define('_PRFOCUS','Focus');
define('_PRFOCUSN','%1$s non lus');
define('_PRFORWARD','Transférer');
define('_PRFOUND','Trouvé %1$s sur %2$s');
define('_PRFREE','%1$s libre');
define('_PRFRESH','Cette semaine');
define('_PRFWD','Transfert');
...
define('_PRLIMSUB','Titre, jusqu\'à %1$s caractères');
define('_PRLIMTO','Nom, jusqu\'à %1$s caractères');
define('_PRLIST','Liste des messages');
...
define('_PRNOHIT','Aucun message ne correspond aux filtres');
define('_PRNOLIMIT','Sans limite');
...
define('_PRPICK','Aucun message sélectionné');
define('_PRPICKT',"Sélectionnez un message à gauche pour le lire et y répondre. L'ouverture d'un message entrant le marque comme lu.");
define('_PRRE','Destinataire');
define('_PRREP','Réponse');
define('_PRRESET','Tout réinitialiser');
...
define('_PRSEEK','Recherche par sujet, texte et nom');
define('_PRSEEN','Lus');
...
define('_PRSHOWN','Affichés %1$s-%2$s');
define('_PRSORT','Tri');
define('_PRSTALE',"Plus d'un mois");
define('_PRUNSEEN','Non lus');
define('_PRVIEW','Lecture du message');
define('_PRWAIT','Intervalle %1$s s');
define('_PRWIPE','Vider le formulaire');
define('_PRWRITE','Écrire');
define('_PURCHASED','Gauche');
define('_QRCODE','Code QR');
...
define('_RATINGS_FORM','La requête d\'évaluation est incorrecte.');
...
define('_SUCCCLEAR','Les données ont été nettoyées avec succès.');
define('_SUCCUPLOAD','Le fichier a été téléchargé avec succès.');
define('_SUCCFILESAVE','Le fichier a été enregistré avec succès.');
define('_SUCCSTATUS','Le statut a été modifié avec succès.');
define('_SEARCH','Recherche');
define('_SEARCHLETMIN','Minimum le nombre de caractères dans une requête de recherche');
define('_SEC','sec');
define('_SECCODEINCOR',"Impossible de passer l'algorithme pour vérifier un utilisateur réel, veuillez contacter l'administration du projet!");
define('_SECURITY','Sécurité');
define('_SHARE','Partager');
...
define('_SUM','Somme');
define('_SYSTEM_INFO','Performances du système');
...
define('_VOTE','Voix');
define('_VOTES','Votes');
define('_VOTING_ACT','Vote en cours');
define('_VOTING_END','Le vote est terminé');
...
define('_SQLERRORCON',"Problème d'établissement d'une connexion à la base de données!");
define('_ERR_TYPE','Type de source non pris en charge');
define('_ERR_ZIPNA','ZIP non disponible');
define('_ERR_ZOPEN','Échec de l\'ouverture ZIP');
define('_ERR_ZADD','Échec de l\'ajout ZIP');
define('_ERR_READ','Lecture échouée');
define('_ERR_WRITE','Écriture échouée');
define('_ERR_DELETE','Suppression échouée');
define('_ERR_NOCOMP','Aucune méthode de compression disponible');
define('_ERR_INVMODE','Mode de compression non valide');
define('_ERR_GZNA','GZIP non disponible');
define('_ERR_BZ2NA','BZIP2 non disponible');
define('_ERR_DIR','Répertoire cible introuvable');
define('_ERR_PARAM','Source ou nom d\'archive manquant');
define('_ERR_FILE','La source doit être un fichier pour gzip/bzip2');
define('_ERR_OPEN','Impossible d\'ouvrir le fichier source');
define('_ERR_GZIP','Impossible de créer l\'archive gzip');
define('_ERR_BZIP','Impossible de créer l\'archive bzip2');

# Captcha widget (ALTCHA)
define('_CAPTCHA_LABEL','Je ne suis pas un robot');
define('_CAPTCHA_VERIFYING','Vérification…');
define('_CAPTCHA_VERIFIED','Vérification réussie !');
define('_CAPTCHA_ERROR','Échec de la vérification. Veuillez réessayer.');
define('_CAPTCHA_EXPIRED','Vérification expirée. Veuillez vérifier à nouveau.');
define('_CAPTCHA_LOADING','Chargement…');
define('_CAPTCHA_REQUIRED','Vérification requise !');
define('_CAPTCHA_WAIT','Vérification en cours… veuillez patienter.');
