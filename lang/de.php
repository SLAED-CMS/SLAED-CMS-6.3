...
define('_CONFIRM','Bestätigung');
define('_COPIED','Link kopiert');
define('_COPYLINK','Link kopieren');
define('_CODE','Code');
...
define('_DEBUGPANEL','Diagnosepanel');
...
define('_EDROPFILES','Dateien hierher ziehen oder das Feld anklicken');
define('_EEMOJI','Emoji');
define('_EEMOJIEMPTY','Keine Emoji');
define('_EEMOJINOTICE','Hinweise');
define('_EEMOJIREACT','Reaktionen');
define('_EEMOJIRECENT','Zuletzt');
define('_EEMOJISMILE','Smileys');
define('_EEMOJISYMBOL','Symbole');
define('_EEXITFULL','Vollbild beenden');
define('_EEXPAND','Fenster vergrößern');
define('_EFULLSCREEN','Editor im Vollbild anzeigen');
define('_EIMGURL','Bildadresse');
define('_EINSOBJ','Miniaturansicht oder Datei einfügen');
define('_EMODEEMBED','In den Text einbetten');
define('_EMODEEMBEDINFO','Das Bild wird als Base64 direkt im Text gespeichert. Nur für kleine Bilder geeignet.');
define('_EMODEUPLOAD','Auf den Server hochladen');
define('_EMODEUPLOADINFO','Die Dateien werden auf den Server hochgeladen. Markieren Sie, was eingefügt werden soll, und klicken Sie auf «Einfügen».');
define('_EMOVEWIN','Fenster verschieben');
define('_ENOEMBED','Dieses Feld kann kein eingebettetes Bild aufnehmen — fügen Sie es über die Adresse ein.');
define('_ENOFILE','Keine Datei');
define('_ERESTORE','Fenster wiederherstellen');
define('_ETABS','Tabs');
define('_ETEXTLONG','Der Text ist länger, als dieses Feld aufnehmen kann — höchstens %s.');
...
define('_EDITOR_MYNOTE','Dateien im Modul: %d');
define('_EDITOR_MYINFO','Bereits hochgeladene Dateien des Moduls. Die Aktionen stehen im Menü der Datei, die Vorschau öffnet das Bild.');
define('_EDITOR_NOUP','Dieser Gruppe ist das Hochladen von Dateien nicht erlaubt');
define('_EDITOR_NOMY','Der Katalog öffnet sich nur zusammen mit dem Recht zum Hochladen');
define('_EDITOR_EMPTY','Der Katalog ist noch leer');
define('_EDITOR_EMPTYWHY','Hochgeladene Dateien erscheinen hier gleich nach dem ersten Hochladen.');
define('_EDITOR_NONE','Nichts gefunden');
define('_EDITOR_NONEWHY','In diesem Verzeichnis passt keine Datei zum Filter.');
define('_EDITOR_FAIL','Die Liste kam nicht an');
define('_EDITOR_FAILWHY','Der Server hat die Anfrage nach dem Katalog nicht beantwortet. Die Dateien liegen dort, die Liste konnte nicht gelesen werden.');
define('_EDITOR_WAIT','Der Katalog wird geladen');
define('_EDITOR_FILTER','Filter nach Namen in diesem Verzeichnis');
define('_EDITOR_IMAGES','Bilder');
define('_EDITOR_ASLIST','Als Liste');
define('_EDITOR_ASGRID','Als Kacheln');
define('_EDITOR_FULL','Den ganzen Katalog öffnen');
define('_EDITOR_OTHERS','Dateien');
define('_EDITOR_PROPS','Eigenschaften der Datei');
define('_EDITOR_NOTE','Gezeigt wird die relative Adresse innerhalb des erlaubten Verzeichnisses des Moduls. Der absolute Serverpfad erreicht dieses Fenster nie.');
define('_EDITOR_DIM','Auflösung');
define('_EDITOR_PERMS','Zugriffsrechte');
define('_EDITOR_OWNER','Eigentümer');
define('_EDITOR_ADDR','Adresse');
define('_EDITOR_MARK','Markieren');
define('_EDITOR_MARKALL','Alle Dateien markieren');
define('_EDITOR_MARKED','Markiert');
define('_EDITOR_INSAS','Einfügen als');
define('_EDITOR_INSERT','Einfügen');
define('_EDITOR_OPTS','Einfügeoptionen');
define('_EDITOR_ALIGN','Textumfluss');
define('_EDITOR_ALIGNNO','Kein Umfluss');
define('_EDITOR_ALIGNLEFT','Links vom Text');
define('_EDITOR_ALIGNRIGHT','Rechts vom Text');
define('_EDITOR_CAPTION','Bildunterschrift');
define('_EDITOR_INSIMGS','Als Bilder einfügen');
define('_EDITOR_INSOBJS','Als Anhänge einfügen');
define('_EDITOR_UNMARK','Markierungen aufheben');
define('_EDITOR_ZIP','Als ZIP packen');
define('_EDITOR_ASKDEL','Die Datei %s löschen?');
define('_EDITOR_ASKDELS','Die markierten Dateien löschen: %d?');
define('_EDITOR_QUEUE','Datei %1$d von %2$d wird hochgeladen');
define('_EDITOR_QUEUEEND','Hochgeladene Dateien: %1$d von %2$d');
define('_EDITOR_STOP','Hochladen abbrechen');
define('_EDITOR_USED','Im Modul belegt');
define('_EDITOR_ROOM','Platz im Eintrag');
define('_EDITOR_MODULE','Modul: %s');
define('_EDITOR_MORE','Gezeigt werden die letzten %1$d Dateien von %2$d.');
define('_EDITOR_PREV','Zurück');
define('_EDITOR_NEXT','Weiter');
...
define('_FAVOR_DONE','Zu Favoriten hinzugefügt');
define('_FAVOR_MODS','Module');
define('_FAVOR_TOP','Am meisten');
define('_FAVOR_LAST','Zuletzt');
define('_FAVOR_FOLD','Klicken Sie auf den Kopf eines Regals, um seine Einträge ein- oder auszuklappen.');
define('_FAVOR_FREE','Frei %1$s von %2$s');
define('_FAVOR_SEEK','In den Favoriten suchen');
define('_FAVOR_SEEKNOTE','Titel oder Modul');
define('_FAVOR_NONE','Nichts gefunden. Löschen Sie die Eingabe oder wählen Sie oben ein Modul.');
define('_FEEDBACK','Kontaktaufnahme');
define('_FIELDS_REQ','Dieses Feld muss ausgefüllt werden.');
define('_FIELDS_TYPE','Der Wert hat die falsche Struktur.');
define('_FIELDS_FORMAT','Der Wert hat das falsche Format.');
define('_FIELDS_CHOICE','Der Wert gehört nicht zu den erlaubten Optionen.');
define('_FIELDS_MIN','Der Wert liegt unter dem erlaubten Minimum.');
define('_FIELDS_MAX','Der Wert liegt über dem erlaubten Maximum.');
define('_FILE','Datei');
...
define('_FRESET','Filter zurücksetzen');
define('_FROM','Von');
...
define('_FUNCTIONS','Optionen');
define('_GENDER','Geschlecht');
define('_GENERATION','Erstellung');
define('_GENERATION_DB','Anfragen zur Datenbank fьr');
define('_PAGETIME','Zeit der Seitengenerierung');
define('_GERMAN','Deutsch');
define('_GOBACK','<input type="button" value="Zurück" class="sl_but_blue" OnClick="javascript:window.history.go(-1);">');
...
define('_INSERTIMG','Bild einfügen');
...
define('_MAN','Mann');
define('_MEDIA','Media');
define('_MEMUSAGE','Speichernutzung und Limit');
define('_DBQUERY','Datenbankabfragen gesamt');
define('_DBQTIME','Zeit der Datenbankabfragen');
...
define('_MODULES_DUPLICATE','Doppelte Module gefunden');
define('_MODULES_NEW','Neue Module gefunden');
define('_MODULES_DELETED','Module gelöscht');
define('_MORE','Mehr');
define('_NAME','Bezeichnung');
define('_NEW','Neu');
define('_NEWLAST3DAYS','Ist fьr die letzten 3 Tage beigefügt');
define('_NEWMONTH','Wurde diesen Monat hinzugefügt');
define('_NEWNOW','Gerade veröffentlicht');
...
define('_NODE_CAST','Mitwirkende');
define('_NODE_COVER','Titelbild');
define('_NODE_CREATOR','Urheber');
define('_NODE_DIRECTOR','Regie');
define('_NODE_MFORMAT','Format');
define('_NODE_PLAY','Wiedergabe');
define('_NODE_POSTER','Vorschaubild');
define('_NODE_QUALITY','Qualität');
define('_NODE_RELEASE','Ausgabe');
define('_NODE_RUNTIME','Laufzeit');
define('_NODE_SUBTITLE','Nebentitel');
define('_NODE_YEAR','Jahr');
define('_NONE','Keine');
...
define('_PLOAD1','Diese Option verlangsamt das System von einer bis zwei Sekunden!');
define('_POINTS','Points');
define('_POINTS_PUBLISH','Veröffentlichung eines Materials oder Themas');
define('_POINTS_COMMENT','Kommentar oder Antwort');
define('_POINTS_VIEW','Gezählter Aufruf');
define('_POINTS_DOWNLOAD','Gezählter Download');
define('_POINTS_VISIT','Gezählter Besuch eines externen Links');
define('_POINTS_POLL','Stimme in einer Umfrage');
define('_POINTS_ORDER','Bestätigte Bestellung');
define('_POINTS_FAVORITE','Hinzufügen zu den Favoriten');
define('_POINTS_MESSAGE','Nachricht oder Anfrage');
define('_POINTS_RECOMMEND','Empfehlung der Website');
define('_POINTS_REGISTER','Registrierung');
define('_POINTS_LOGIN','Gezählte Anmeldung');
define('_POINTS_REPORT','Bestätigte nützliche Meldung');
define('_POINTS_MODERATE','Abgeschlossene Moderatoraktion');
define('_POINTS_ADJUST','Korrektur durch einen Administrator');
define('_POINTS_PERIOD','Zeitraum, Sek.');
define('_POINTS_LIMIT','Belohnungen pro Zeitraum');
...
define('_PRBACK','Zur Liste');
define('_PRBOXFULL','Postfach ist voll');
define('_PRBOXNEAR','Postfach fast voll');
define('_PRBOXROOM','Postfach hat Platz');
define('_PRBYMATE','Nach Gegenüber');
define('_PRBYNEW','Neueste zuerst');
define('_PRBYOLD','Älteste zuerst');
define('_PRBYUNS','Ungelesene zuerst');
define('_PRESENTATION','Präsentation');
define('_PREVIEW','Vorschau');
define('_PRFILLED','%1$s zu %2$s Prozent gefüllt');
define('_PRFILTER','Filter');
define('_PRFOCUS','Fokus');
define('_PRFOCUSN','%1$s ungelesen');
define('_PRFORWARD','Weiterleiten');
define('_PRFOUND','%1$s von %2$s gefunden');
define('_PRFREE','%1$s frei');
define('_PRFRESH','Letzte Woche');
define('_PRFWD','Weitergeleitet');
...
define('_PRLIMSUB','Betreff, bis zu %1$s Zeichen');
define('_PRLIMTO','Name, bis zu %1$s Zeichen');
define('_PRLIST','Nachrichtenliste');
...
define('_PRNOHIT','Keine Nachricht passt zu den Filtern');
define('_PRNOLIMIT','Ohne Begrenzung');
...
define('_PRPICK','Keine Nachricht ausgewählt');
define('_PRPICKT','Wählen Sie links eine Nachricht, um sie zu lesen und zu beantworten. Das Öffnen einer eingehenden Nachricht markiert sie als gelesen.');
define('_PRRE','Empfänger');
define('_PRREP','Antwort');
define('_PRRESET','Alles zurücksetzen');
...
define('_PRSEEK','Suche nach Betreff, Text und Name');
define('_PRSEEN','Gelesene');
...
define('_PRSHOWN','Angezeigt %1$s-%2$s');
define('_PRSORT','Sortierung');
define('_PRSTALE','Älter als ein Monat');
define('_PRUNSEEN','Ungelesene');
define('_PRVIEW','Nachrichtenansicht');
define('_PRWAIT','Intervall %1$s Sek.');
define('_PRWIPE','Formular leeren');
define('_PRWRITE','Schreiben');
...
define('_RATINGS_FORM','Die Bewertungsanfrage ist fehlerhaft.');
define('_RATINGS_DENY','Bewertung nicht möglich: Die Bewertung ist deaktiviert, für Gäste gesperrt oder es ist Ihr eigener Beitrag.');
define('_RATINGS_GONE','Das bewertete Objekt wurde nicht gefunden.');
...
define('_SUCCCLEAR','Die Daten wurden erfolgreich bereinigt.');
define('_SUCCUPLOAD','Die Datei wurde erfolgreich hochgeladen.');
define('_SUCCFILESAVE','Die Datei wurde erfolgreich gespeichert.');
define('_SUCCSTATUS','Der Status wurde erfolgreich geändert.');
define('_SEARCH','Suche');
define('_SEARCHLETMIN','Die minimal zulässige Menge der Symbole in der Suchabfrage');
define('_SEC','sek');
define('_SECCODEINCOR','Der Algorithmus zur Prüfung auf einen echten Benutzer konnte nicht bestanden werden, bitte kontaktieren Sie die Projektverwaltung!');
define('_SECURITY','Sicherheit');
define('_SHARE','Teilen');
...
define('_VOTING_ACT','Abstimmung läuft');
define('_VOTING_END','Abstimmung beendet');
...
define('_SQLERRORCON','Problem beim Herstellen einer Verbindung zur Datenbank!');
define('_ERR_TYPE','Nicht unterstützter Quelltyp');
define('_ERR_ZIPNA','ZIP nicht verfügbar');
define('_ERR_ZOPEN','ZIP konnte nicht geöffnet werden');
define('_ERR_ZADD','ZIP hinzufügen fehlgeschlagen');
define('_ERR_READ','Lesen fehlgeschlagen');
define('_ERR_WRITE','Schreiben fehlgeschlagen');
define('_ERR_DELETE','Löschen fehlgeschlagen');
define('_ERR_NOCOMP','Keine Kompressionsmethode verfügbar');
define('_ERR_INVMODE','Ungültiger Kompressionsmodus');
define('_ERR_GZNA','GZIP nicht verfügbar');
define('_ERR_BZ2NA','BZIP2 nicht verfügbar');
define('_ERR_DIR','Zielverzeichnis nicht gefunden');
define('_ERR_PARAM','Fehlende Quelle oder Archivname');
define('_ERR_FILE','Quelle muss eine Datei sein für gzip/bzip2');
...
define('_CAPTCHA_VERIFIED','Überprüfung erfolgreich abgeschlossen!');
