...
define('_EINSOBJINFO','Для зображення буде вставлено мініатюру з відкриттям оригіналу в модальному вікні. Для інших файлів — подання, налаштоване для типу файлу.');
