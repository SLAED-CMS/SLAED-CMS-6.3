...
define('_ERROR_PAGE','Сталася помилка %1$s. Запитувана сторінка недоступна або не існує. Можливо, ви перейшли за застарілим посиланням, помилилися адресою, або сталася помилка на сервері. Зараз ви будете перенаправлені на головну сторінку сайту.');
