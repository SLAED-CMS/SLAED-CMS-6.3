...
define('_AND','і');
define('_ANONYM','Гість');
define('_AQUERY_DB','Запити до бази даних');
define('_AUTH_ERROR','Для використання даного функціоналу, адміністратору системи необхідно встановити додаткові пароль та логін в панелі адміністрації, відділ: «Безпека». В разі виникнення питань чи проблем, рекомендуємо звернутися в службу технічної підтримки проекту SLAED за адресою: https://slaed.net');
define('_AUTH_ERROR_IP','Доступ у даний відділ з використовуваним IP Адресою заборонений!');
define('_AVARIABLES','Змінні запиту');
...
define('_CONFIRM','Підтвердження');
define('_COPIED','Посилання скопійовано');
define('_COPYLINK','Копіювати посилання');
define('_CODE','Код');
...
define('_DEBUGPANEL','Панель діагностики');
...
define('_ERROR_PAGE','Сталася помилка %1$s. Запитувана сторінка недоступна або не існує. Можливо, ви перейшли за застарілим посиланням, помилилися адресою, або сталася помилка на сервері. Поверніться на головну сторінку або скористайтеся пошуком.');
...
define('_ERRLOG','Помилки та попередження');
define('_ERROR_PASS','Введені паролі не збігаються!');
define('_ERROR_SERV','Файл цього типу зараз не може бути оброблений на сервері!');
define('_ERROR_SIZE','Розмір завантаженого графічного елемента перевищує допустимий!');
define('_ERROR_UP','Помилка запису файлу!');
define('_EATTACH','Вкладення');
define('_EDROPFILES','Перетягніть файли сюди або натисніть на поле');
define('_EEMOJI','Смайли');
define('_EEMOJIEMPTY','Немає emoji');
define('_EEMOJINOTICE','Нотатки');
define('_EEMOJIREACT','Реакції');
define('_EEMOJIRECENT','Останні');
define('_EEMOJISMILE','Смайли');
define('_EEMOJISYMBOL','Символи');
define('_EEXITFULL','Вийти з повноекранного режиму');
define('_EEXPAND','Розгорнути вікно');
define('_EFULLSCREEN','Розгорнути редактор на весь екран');
define('_EIMGURL','Адреса зображення');
define('_EINSOBJ','Вставити мініатюру або файл');
define('_EMODEEMBED','Вбудувати в текст');
define('_EMODEEMBEDINFO','Зображення кодується в base64 і зберігається просто в тексті. Лише для невеликих зображень.');
define('_EMODEUPLOAD','Завантажити на сервер');
define('_EMODEUPLOADINFO','Файли буде завантажено на сервер. Позначте потрібні та натисніть «Вставити».');
define('_EMOVEWIN','Перемістити вікно');
define('_ENOEMBED','Це поле не може містити вбудоване зображення — вставте його за адресою.');
define('_ENOFILE','Файл не вибрано');
define('_ERESTORE','Відновити вікно');
define('_ETABS','Вкладки');
define('_ETEXTLONG','Текст довший, ніж вміщає це поле — не більше %s.');
define('_EUPLOAD','Файловий менеджер');
define('_EUSEHTML','Використовувати HTML код');
define('_EUSEPHP','Використовувати PHP код');
define('_EDITOR_STORE','Сховище');
define('_EDITOR_LINK','Посилання на зображення');
define('_EDITOR_LINKNOTE','Файл не завантажується, але зображення доступне за вказаною адресою.');
define('_EDITOR_LINKINFO','Зображення підключається за зовнішньою адресою, на сервер нічого не потрапляє.');
define('_EDITOR_LINKWARN','Файл залишається на чужому сервері. До квоти модуля він не входить, але й збереження його не гарантується.');
define('_EDITOR_MY','Мої файли');
define('_EDITOR_MYNOTE','Файлів у модулі: %d');
define('_EDITOR_MYINFO','Вже завантажені файли модуля. Дії — у меню файлу, попередній перегляд — за натисканням на картинку.');
define('_EDITOR_NOUP','Групі не дозволено завантаження файлів');
define('_EDITOR_NOMY','Каталог доступний лише разом із правом завантаження');
define('_EDITOR_EMPTY','Каталог поки що порожній');
define('_EDITOR_EMPTYWHY','Завантажені файли з\'являться тут одразу після першого завантаження.');
define('_EDITOR_NONE','Нічого не знайдено');
define('_EDITOR_NONEWHY','У цій директорії немає файлів, що відповідають фільтру.');
define('_EDITOR_FAIL','Список не завантажився');
define('_EDITOR_FAILWHY','Сервер не відповів на запит каталогу. Файли на місці, отримати список не вдалося.');
define('_EDITOR_WAIT','Каталог завантажується');
define('_EDITOR_FILTER','Фільтр за назвою в цій директорії');
define('_EDITOR_IMAGES','Картинки');
define('_EDITOR_ASLIST','Списком');
define('_EDITOR_ASGRID','Плитками');
define('_EDITOR_FULL','Відкрити весь каталог');
define('_EDITOR_OTHERS','Файли');
define('_EDITOR_PROPS','Властивості файлу');
define('_EDITOR_NOTE','Показано відносну адресу всередині дозволеної директорії модуля. Абсолютний шлях на сервері у вікно не передається.');
define('_EDITOR_DIM','Роздільність');
define('_EDITOR_PERMS','Права доступу');
define('_EDITOR_OWNER','Власник');
define('_EDITOR_ADDR','Адреса');
define('_EDITOR_MARK','Позначити');
define('_EDITOR_MARKALL','Позначити всі файли');
define('_EDITOR_MARKED','Позначено');
define('_EDITOR_INSAS','Вставити як');
define('_EDITOR_INSERT','Вставити');
define('_EDITOR_OPTS','Параметри вставлення');
define('_EDITOR_ALIGN','Обтікання текстом');
define('_EDITOR_ALIGNNO','Без обтікання');
define('_EDITOR_ALIGNLEFT','Ліворуч від тексту');
define('_EDITOR_ALIGNRIGHT','Праворуч від тексту');
define('_EDITOR_CAPTION','Підпис');
define('_EDITOR_INSIMGS','Вставити зображеннями');
define('_EDITOR_INSOBJS','Вставити вкладеннями');
define('_EDITOR_UNMARK','Зняти позначки');
define('_EDITOR_ZIP','Стиснути в ZIP');
define('_EDITOR_ASKDEL','Видалити файл %s?');
define('_EDITOR_ASKDELS','Видалити позначені файли: %d?');
define('_EDITOR_QUEUE','Завантажується файл %1$d з %2$d');
define('_EDITOR_QUEUEEND','Завантажено файлів: %1$d з %2$d');
define('_EDITOR_STOP','Скасувати завантаження');
define('_EDITOR_USED','Зайнято в модулі');
define('_EDITOR_ROOM','Місце в записі');
define('_EDITOR_MODULE','Модуль: %s');
define('_EDITOR_MORE','Показано %1$d останніх файлів із %2$d.');
define('_EDITOR_PREV','Попередній');
define('_EDITOR_NEXT','Наступний');
...
define('_FAVOR_DONE','Додано до фаворитів');
define('_FAVOR_MODS','Модулів');
define('_FAVOR_TOP','Найбільше');
define('_FAVOR_LAST','Остання');
define('_FAVOR_FOLD','Натисніть на заголовок полиці, щоб згорнути або розгорнути матеріали.');
define('_FAVOR_FREE','Вільно %1$s з %2$s');
define('_FAVOR_SEEK','Знайти серед фаворитів');
define('_FAVOR_SEEKNOTE','Назва матеріалу або модуль');
define('_FAVOR_NONE','Нічого не знайдено. Зітріть запит або виберіть модуль чипом вище.');
define('_FEEDBACK',"Зворотній зв'язок");
define('_FIELDS_REQ','Це поле обов\'язкове для заповнення.');
define('_FIELDS_TYPE','Значення має неправильну структуру.');
define('_FIELDS_FORMAT','Значення має неправильний формат.');
define('_FIELDS_CHOICE','Значення не входить до списку дозволених варіантів.');
define('_FIELDS_MIN','Значення менше допустимого мінімуму.');
define('_FIELDS_MAX','Значення більше допустимого максимуму.');
define('_FILE','Файл');
define('_FILES','Каталог файлів');
define('_FILEUP','Кількість одночасно завантажуваних файлів');
define('_FILE_RENAMED','Файл завантажений і отримав назву');
...
define('_FUNCTIONS','Опції');
define('_GENDER','Пол');
define('_GENERATION','Генерація');
define('_GENERATION_DB','запросов к базе данных за');
define('_PAGETIME','Час генерації сторінки');
define('_GERMAN','Німецька');
define('_GOBACK','<input type="button" value="Назад" class="sl_but_blue" OnClick="javascript:window.history.go(-1);">');
define('_GROUP','Група');
...
define('_MEMUSAGE',"Використання та об'єм пам'яті");
define('_DBQUERY','Усього запитів до бази даних');
define('_DBQTIME','Час запитів до бази даних');
...
define('_MIN','хв');
define('_MODE_AUTO','Системна');
define('_MODE_LIGHT','Світла');
define('_MODE_DARK','Темна');
...
define('_NEWMONTH','Додано цього місяця');
define('_NEWNOW','Щойно опубліковано');
define('_NEWS','Новини');
...
define('_NODE_CAST','Учасники');
define('_NODE_COVER','Обкладинка');
define('_NODE_CREATOR','Творець');
define('_NODE_DIRECTOR','Режисер');
define('_NODE_MFORMAT','Формат');
define('_NODE_PLAY','Відтворення');
define('_NODE_POSTER','Заставка');
define('_NODE_QUALITY','Якість');
define('_NODE_RELEASE','Випуск');
define('_NODE_RUNTIME','Тривалість');
define('_NODE_SUBTITLE','Додаткова назва');
define('_NODE_YEAR','Рік');
define('_NONE','Немає');
define('_NOPASS','Ви не вказали і не повторили пароль!');
define('_NOTE','Примітка');
define('_NO_INFO','Немає інформації');
define('_NUMOF','%1$s з %2$s');
...
define('_PLOAD1','Дана опція уповільнює роботу системи від однієї до двох секунд!');
define('_POINTS','Пункти');
define('_POINTS_PUBLISH','Публікація матеріалу або теми');
define('_POINTS_COMMENT','Коментар або відповідь');
define('_POINTS_VIEW','Зарахований перегляд');
define('_POINTS_DOWNLOAD','Зараховане завантаження');
define('_POINTS_VISIT','Зарахований перехід за зовнішнім посиланням');
define('_POINTS_POLL','Голос в опитуванні');
define('_POINTS_ORDER','Підтверджене замовлення');
define('_POINTS_FAVORITE','Додавання до обраного');
define('_POINTS_MESSAGE','Повідомлення або звернення');
define('_POINTS_RECOMMEND','Рекомендація сайту');
define('_POINTS_REGISTER','Реєстрація');
define('_POINTS_LOGIN','Зарахований вхід');
define('_POINTS_REPORT','Підтверджена корисна скарга');
define('_POINTS_MODERATE','Завершена дія модератора');
define('_POINTS_ADJUST','Коригування адміністратором');
define('_POINTS_PERIOD','Період, сек.');
define('_POINTS_LIMIT','Нагород за період');
...
define('_PRBACK','До списку');
define('_PRBOXFULL','Скринька повна');
define('_PRBOXNEAR','Скринька майже повна');
define('_PRBOXROOM','У скриньці є місце');
define('_PRBYMATE','За співрозмовником');
define('_PRBYNEW','Спочатку нові');
define('_PRBYOLD','Спочатку старі');
define('_PRBYUNS','Непрочитані зверху');
define('_PRESENTATION','Презентація');
define('_PREVIEW','Попередній перегляд');
define('_PRFILLED','%1$s заповнені на %2$s відсотків');
define('_PRFILTER','Фільтр');
define('_PRFOCUS','Фокус');
define('_PRFOCUSN','%1$s непрочитаних');
define('_PRFORWARD','Переслати');
define('_PRFOUND','Знайдено %1$s з %2$s');
define('_PRFREE','Вільно %1$s');
define('_PRFRESH','За тиждень');
define('_PRFWD','Пересилання');
define('_PRIN','Вхідні');
...
define('_PRIVAT_DELIN','Видалено отримувачем');
define('_PRIVAT_DELOUT','Видалено відправником');
define('_PRIVAT_NEW','Позначити непрочитаними');
define('_PRIVAT_NOSEL','Виберіть повідомлення, до яких застосовується дія.');
define('_PRIVAT_READ','Позначити прочитаними');
define('_PRIVAT_UNSAVE','Прибрати зі збережених');
define('_PRLIMSUB','Заголовок, до %1$s символів');
define('_PRLIMTO','Ім\'я, до %1$s символів');
define('_PRLIST','Список повідомлень');
...
define('_PRNOHIT','Під фільтри не потрапило жодного листа');
define('_PRNOLIMIT','Без обмеження');
...
define('_PRPICK','Лист не вибрано');
define('_PRPICKT','Виберіть повідомлення ліворуч, щоб прочитати його та відповісти. Відкриття вхідного одразу позначає його прочитаним.');
define('_PRRE','Одержувач');
define('_PRREP','Відповідь');
define('_PRRESET','Скинути все');
...
define('_PRSEEK','Пошук за темою, текстом та іменем');
define('_PRSEEN','Прочитані');
...
define('_PRSHOWN','Показано %1$s–%2$s');
define('_PRSORT','Сортування');
define('_PRSTALE','Старші за місяць');
define('_PRUNSEEN','Непрочитані');
define('_PRVIEW','Перегляд повідомлення');
define('_PRWAIT','Інтервал %1$s сек.');
define('_PRWIPE','Очистити форму');
define('_PRWRITE','Написати');
define('_PURCHASED','Залишилося');
define('_QRCODE','QR-код');
...
define('_RATINGS_FORM','Невірні параметри оцінки.');
define('_RATINGS_DENY','Оцінка недоступна: рейтинг вимкнено, закрито для гостей або це ваш власний матеріал.');
define('_RATINGS_GONE','Об\'єкт оцінки не знайдено.');
define('_RATINGS_TWICE','Цей запит уже прийнято з іншою оцінкою.');
define('_RATINGS_WAIT','Ви вже оцінювали. Днів до наступної оцінки: %d');
define('_RATINGS_FAIL','Оцінку не збережено, повторіть спробу.');
...
define('_SUCCSAVE','Зміни успішно збережено.');
define('_SUCCDELETE',"Об'єкт успішно видалено.");
define('_SUCCCLEAR','Дані успішно очищено.');
define('_SUCCUPLOAD','Файл успішно завантажено.');
define('_SUCCFILESAVE','Файл успішно збережено.');
define('_SUCCSTATUS','Статус успішно змінено.');
define('_SEARCH','Пошук');
define('_SEARCHLETMIN','Мінімально допустима кількість символів у пошуковому запиті');
define('_SEC','сек');
define('_SECCODEINCOR','Не пройдено алгоритм перевірки на реального користувача, будь ласка зверніться до адміністрації проекту!');
define('_SECURITY','Безпека');
define('_SHARE','Поділитися');
...
define('_TPLMISS','Помилка підключення шаблону! Шаблон, вказаний у функції, відсутній у директорії активної теми: %1$s. Рекомендована назва файлу: %2$s.html');
define('_VIEW','Хто бачить');
define('_VIEWS','Пр.');
define('_VOPEN','Відкритий опитування');
define('_VOTE','Голос');
define('_VOTES','Голосів');
define('_VOTING_ACT','Триває голосування');
define('_VOTING_END','Голосування завершено');
...
define('_WOMAN','Жінка');
define('_YES','Так');
define('_YESTERDAY','Вчора');
define('_YOUREMAIL','Ваш E-Mail');
define('_YOURNAME',"Ваше ім'я");
define('_ZIP','Zip стиснення');
define('_SQLERRORCON',"Проблема встановлення з'єднання з базою даних!");
define('_ERR_TYPE','Непідтримуваний тип джерела');
define('_ERR_ZIPNA','ZIP недоступний');
define('_ERR_ZOPEN','Не вдалося відкрити ZIP');
define('_ERR_ZADD','Не вдалося додати в ZIP');
define('_ERR_READ','Помилка читання');
define('_ERR_WRITE','Помилка запису');
define('_ERR_DELETE','Помилка видалення');
define('_ERR_NOCOMP','Немає доступного методу стиснення');
define('_ERR_INVMODE','Невірний режим стиснення');
define('_ERR_GZNA','GZIP недоступний');
define('_ERR_BZ2NA','BZIP2 недоступний');
define('_ERR_DIR','Цільовий каталог не знайдено');
define('_ERR_PARAM','Відсутнє джерело або назва архіву');
define('_ERR_FILE','Джерело має бути файлом для gzip/bzip2');
define('_ERR_OPEN','Неможливо відкрити вихідний файл');
define('_ERR_GZIP','Неможливо створити gzip-архів');
define('_ERR_BZIP','Неможливо створити bzip2-архів');

# Captcha widget (ALTCHA)
define('_CAPTCHA_LABEL','Я не робот');
define('_CAPTCHA_VERIFYING','Перевірка…');
define('_CAPTCHA_VERIFIED','Перевірку успішно завершено!');
