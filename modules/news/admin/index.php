...
function add(): void {
    ...
    $rows = [
        ...
        ['label_html' => _FIXED.'?', 'label_id' => $labid = getFieldIds('', 'fix')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'fix', 'value' => (string)$fix, 'options' => [['value' => '1', 'label' => _YES], ['value' => '0', 'label' => _NO]]])],
        ['label_html' => _ASSOTOPIC, 'hint_html' => _ASSOTOPICI, 'hint_id' => 'f-associated-hint', 'field_html' => $assohtml, 'is_full' => true],
    ];
...
function config(): void {
    ...
    $rows = [
        ...
        ['label_html' => _HOMCAT, 'label_id' => $labid = getFieldIds('', 'homcat')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'homcat', 'value' => (string)($conf['news']['homcat'] ?? 0), 'options' => $yesno])],
        ['label_html' => _VIEWCAT, 'label_id' => $labid = getFieldIds('', 'viewcat')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'viewcat', 'value' => (string)($conf['news']['viewcat'] ?? 0), 'options' => $yesno])],
        ['label_html' => _C_32, 'label_id' => $labid = getFieldIds('', 'catdesc')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'catdesc', 'value' => (string)($conf['news']['catdesc'] ?? 0), 'options' => $yesno])],
        ['label_html' => _C_15, 'label_id' => $labid = getFieldIds('', 'subcat')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'subcat', 'value' => (string)($conf['news']['subcat'] ?? 0), 'options' => $yesno])],
        ['label_html' => _ADDAMAIL, 'label_id' => $labid = getFieldIds('', 'addmail')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'addmail', 'value' => (string)($conf['news']['addmail'] ?? 0), 'options' => $yesno])],
        ['label_html' => _C_39, 'label_id' => $labid = getFieldIds('', 'add')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'add', 'value' => (string)($conf['news']['add'] ?? 0), 'options' => $yesno])],
        ['label_html' => _C_40, 'label_id' => $labid = getFieldIds('', 'addquest')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'addquest', 'value' => (string)($conf['news']['addquest'] ?? 0), 'options' => $yesno])],
        ['label_html' => _C_37, 'label_id' => $labid = getFieldIds('', 'autor')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'autor', 'value' => (string)($conf['news']['autor'] ?? 0), 'options' => $yesno])],
        ['label_html' => _C_17, 'label_id' => $labid = getFieldIds('', 'date')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'date', 'value' => (string)($conf['news']['date'] ?? 0), 'options' => $yesno])],
        ['label_html' => _C_INTRO, 'label_id' => $labid = getFieldIds('', 'intro')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'intro', 'value' => (string)($conf['news']['intro'] ?? 1), 'options' => $yesno])],
        ['label_html' => _C_18, 'label_id' => $labid = getFieldIds('', 'read')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'read', 'value' => (string)($conf['news']['read'] ?? 0), 'options' => $yesno])],
        ['label_html' => _C_19, 'label_id' => $labid = getFieldIds('', 'rate')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'rate', 'value' => (string)($conf['news']['rate'] ?? 0), 'options' => $yesno])],
        ['label_html' => _C_20, 'label_id' => $labid = getFieldIds('', 'letter')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'letter', 'value' => (string)($conf['news']['letter'] ?? 0), 'options' => $yesno])],
        ['label_html' => _C_23, 'label_id' => $labid = getFieldIds('', 'assoc')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'assoc', 'value' => (string)($conf['news']['assoc'] ?? 0), 'options' => $yesno])],
    ];
    $cont .= $tpl->getHtmlPart('box', ['content_html' => $tpl->getHtmlPart('form', [
