...
function changelog(): void {
    ...
    $cont = $tpl->getHtmlPart('changelog', [
        ...
        'filter_button' => ['button_type' => 'submit', 'submit_label' => _CHLOG_FILTER_BTN, 'button_class' => 'sl-changelog-button sl-changelog-button-primary'],
        'reset_button' => ['button_type' => 'button', 'submit_label' => _CHLOG_RESET_BTN, 'button_class' => 'sl-changelog-button sl-changelog-button-secondary', 'reset_url' => 'index.php?name='.$conf['name']],
