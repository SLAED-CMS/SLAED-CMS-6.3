...
define('_ACCOUNT_BLOCKNOTE','Un menu désactivé n\'est pas affiché, mais le texte ci-dessous est conservé.');
define('_ACCOUNT_CLEAN','Aucun avertissement');
define('_ACCOUNT_EXITNOTE','Terminer la session');
define('_ACCOUNT_FIELDS','Champs supplémentaires');
define('_ACCOUNT_FILLED','Complétude du profil');
define('_ACCOUNT_FSMAILNOTE','Un message arrive pour chaque réponse dans votre sujet.');
define('_ACCOUNT_HIDDEN','Masquée');
define('_ACCOUNT_HUB','Contribution par modules');
define('_ACCOUNT_ITEMS','Contenus');
define('_ACCOUNT_LEFT','Champs restants');
define('_ACCOUNT_MAIL','Publications et courrier');
define('_ACCOUNT_MAILALL','Toutes les notifications sont actives');
define('_ACCOUNT_MAILHEAD','Combien afficher et quoi envoyer par courrier');
define('_ACCOUNT_MAILHIDE','Les autres membres ne voient pas l\'adresse');
define('_ACCOUNT_MAILOFF','Certaines notifications sont désactivées');
define('_ACCOUNT_MAILSHOW','Les autres membres voient l\'adresse');
define('_ACCOUNT_MEMBER','Membre ordinaire');
define('_ACCOUNT_NEWSNOTE','La lettre du site arrive à votre adresse.');
define('_ACCOUNT_NEXT','Jusqu\'au groupe suivant : %s');
define('_ACCOUNT_NOPASS','Sans mot de passe');
define('_ACCOUNT_PERSON','Personnel');
define('_ACCOUNT_PRIVACY','Confidentialité et apparence');
define('_ACCOUNT_PRIVHEAD','Ce que voient les autres et l\'apparence du site pour vous');
define('_ACCOUNT_PSMAILNOTE','Ils restent visibles dans le cabinet sans courrier.');
define('_ACCOUNT_SAFE','Protégé');
define('_ACCOUNT_SECTIONS','Sections des paramètres');
define('_ACCOUNT_SETUPNOTE','Profil, avatar, mot de passe');
define('_ACCOUNT_SHOWN','Visible');
define('_ACCOUNT_STORYNOTE','Combien d\'entrées affichent les listes de nouvelles et d\'articles.');
define('_ACCOUNT_SYSTEM','Système');
define('_ACCOUNT_THEMENOTE','L\'apparence du site pour vous seul. Le choix n\'affecte pas les autres utilisateurs.');
define('_ACCOUNT_UNDO','Annuler');
define('_ACCOUNT_UNSAVED','Des modifications ne sont pas enregistrées');
define('_ACCOUNT_VIEWNOTE','Une adresse masquée n\'apparaît même pas dans vos informations.');
...
define('_OAUTHDONE','Le compte externe a été lié à votre profil!');
define('_OAUTHFAIL',"L'autorisation via le service externe a échoué. Veuillez réessayer de vous connecter.");
define('_OAUTHINTRO','Vous vous êtes connecté avec succès via un service externe. Liez-le à un compte existant ou créez-en un nouveau.');
define('_OAUTHLAST','Impossible de délier la dernière méthode de connexion du compte!');
define('_OAUTHLINK','Lier à un compte existant');
define('_OAUTHLINKT','Saisissez le login et le mot de passe de votre compte pour y rattacher la connexion via le service externe.');
define('_OAUTHNEW','Créer un nouveau compte');
define('_OAUTHNEWT','Le compte sera créé sans mot de passe, la connexion se fait via le service externe. Un mot de passe pourra être défini plus tard via la récupération de mot de passe.');
define('_OAUTHNONE','Aucun service externe lié.');
define('_OAUTHNOPW','Aucun mot de passe défini. Créez-en un via la récupération de mot de passe.');
define('_OAUTHOFF','Le compte externe a été délié de votre profil!');
define('_OAUTHTAB','Services externes');
define('_OAUTHTITLE','Finalisation de la connexion');
...
define('_PASSESEND',"Pour l'utilisateur %1\$s a enregistré sur le site «%2\$s» a été effectué le changement de mot de passe.<br><br>Votre identifiant de connexion est: %3\$s<br>le Lien de session: %4\$s");
...
define('_PASSTEXT',"Après un changement réussi, le nouveau mot de passe prend effet immédiatement et votre session reste ouverte, il n'est pas nécessaire de vous reconnecter. Si rien ne fonctionne pas, contactez votre administrateur de site pour la résolution de ce problème.");
