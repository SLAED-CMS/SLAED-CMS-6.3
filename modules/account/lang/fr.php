...
define('_ACCOUNT_FILLNOTE','Un profil complet est plus visible dans la recherche de membres.');
...
define('_ACCOUNT_LINKED','%s lié');
define('_ACCOUNT_LOG','Journal du compte');
...
define('_ACCOUNT_SIGNIN','Connexion via %s');
