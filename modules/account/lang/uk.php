...
define('_ACCOUNT_BLOCKNOTE','Вимкнене меню не показується, але текст нижче зберігається.');
define('_ACCOUNT_CLEAN','Без попереджень');
define('_ACCOUNT_EXITNOTE','Завершити сеанс');
define('_ACCOUNT_FIELDS','Додаткові поля');
define('_ACCOUNT_FILLED','Заповненість профілю');
define('_ACCOUNT_FSMAILNOTE','Лист надходить на кожну відповідь у вашій темі.');
define('_ACCOUNT_HIDDEN','Приховано');
define('_ACCOUNT_HUB','Внесок за модулями');
define('_ACCOUNT_ITEMS','Матеріали');
define('_ACCOUNT_LEFT','Залишилось полів');
define('_ACCOUNT_MAIL','Публікації та пошта');
define('_ACCOUNT_MAILALL','Усі сповіщення увімкнено');
define('_ACCOUNT_MAILHEAD','Скільки показувати і про що писати на пошту');
define('_ACCOUNT_MAILHIDE','Інші учасники не бачать адресу');
define('_ACCOUNT_MAILOFF','Частину сповіщень вимкнено');
define('_ACCOUNT_MAILSHOW','Інші учасники бачать адресу');
define('_ACCOUNT_MEMBER','Звичайний учасник');
define('_ACCOUNT_NEWSNOTE','Розсилка сайту надходить на вашу адресу.');
define('_ACCOUNT_NEXT','До наступної групи: %s');
define('_ACCOUNT_NOPASS','Без пароля');
define('_ACCOUNT_PERSON','Особисте');
define('_ACCOUNT_PRIVACY','Приватність та вигляд');
define('_ACCOUNT_PRIVHEAD','Що бачать інші і як сайт виглядає для вас');
define('_ACCOUNT_PSMAILNOTE','У кабінеті вони видні й без листа.');
define('_ACCOUNT_SAFE','Захищено');
define('_ACCOUNT_SECTIONS','Розділи налаштувань');
define('_ACCOUNT_SETUPNOTE','Профіль, аватар, пароль');
define('_ACCOUNT_SHOWN','Видно');
define('_ACCOUNT_STORYNOTE','Скільки записів показувати у списках новин і статей.');
define('_ACCOUNT_SYSTEM','Система');
define('_ACCOUNT_THEMENOTE','Як сайт виглядає особисто для вас. На інших користувачів вибір не впливає.');
define('_ACCOUNT_UNDO','Скасувати');
define('_ACCOUNT_UNSAVED','Є незбережені зміни');
define('_ACCOUNT_VIEWNOTE','Прихована адреса не показується навіть у вашій інформації.');
define('_ACCOUNT_WORK','Професія');
define('_ACCOUNT_YEARS','Років із проектом');
...
define('_OAUTHDONE','Зовнішній акаунт прив\'язано до Вашого профілю!');
define('_OAUTHFAIL','Помилка авторизації через зовнішній сервіс. Спробуйте увійти знову.');
define('_OAUTHINTRO','Ви успішно авторизувалися через зовнішній сервіс. Прив\'яжіть його до наявного акаунта або створіть новий.');
define('_OAUTHLAST','Не можна відв\'язати останній спосіб входу в акаунт!');
define('_OAUTHLINK','Прив\'язати до наявного акаунта');
define('_OAUTHLINKT','Введіть логін і пароль Вашого акаунта, щоб прив\'язати до нього вхід через зовнішній сервіс.');
define('_OAUTHNEW','Створити новий акаунт');
define('_OAUTHNEWT','Акаунт буде створено без пароля, вхід виконується через зовнішній сервіс. Пароль можна встановити пізніше через відновлення пароля.');
define('_OAUTHNONE','Немає прив\'язаних зовнішніх сервісів.');
define('_OAUTHNOPW','Пароль не встановлено. Задайте його через процедуру відновлення пароля.');
define('_OAUTHOFF','Зовнішній акаунт відв\'язано від Вашого профілю!');
define('_OAUTHTAB','Зовнішні сервіси');
define('_OAUTHTITLE','Завершення входу');
...
define('_PASSESEND','Для користувача %1$s зареєстрованого на сайті «%2$s» була успішно проведена зміна пароля.<br><br>Ваш логін: %3$s<br>Посилання входу: %4$s');
...
define('_PASSTEXT','Після успішної зміни новий пароль діє одразу, а ваш сеанс залишається відкритим — заходити заново не потрібно. Якщо нічого не вийде, зверніться до адміністратора сайту для вирішення цієї проблеми.');
