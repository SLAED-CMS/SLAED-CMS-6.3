...
define('_ACCOUNT_FILLNOTE','Заповнений профіль помітніший у пошуку за користувачами.');
...
define('_ACCOUNT_LINKED','Прив\'язано %s');
define('_ACCOUNT_LOG','Журнал акаунта');
...
define('_ACCOUNT_SIGNIN','Вхід через %s');
