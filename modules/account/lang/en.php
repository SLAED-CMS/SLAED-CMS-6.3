...
define('_ACCOUNT_FILLNOTE','A filled profile is easier to find in the member search.');
...
define('_ACCOUNT_LINKED','%s linked');
define('_ACCOUNT_LOG','Account journal');
...
define('_ACCOUNT_SIGNIN','Sign-in via %s');
