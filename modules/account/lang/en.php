...
define('_ACCOUNT_BLOCKNOTE','A switched-off menu is not shown, but the text below is kept.');
define('_ACCOUNT_CLEAN','No warnings');
define('_ACCOUNT_EXITNOTE','End the session');
define('_ACCOUNT_FIELDS','Additional fields');
define('_ACCOUNT_FILLED','Profile completeness');
define('_ACCOUNT_FSMAILNOTE','A letter comes for every reply in your topic.');
define('_ACCOUNT_HIDDEN','Hidden');
define('_ACCOUNT_HUB','Contribution by modules');
define('_ACCOUNT_ITEMS','Materials');
define('_ACCOUNT_LEFT','Fields left');
define('_ACCOUNT_MAIL','Publications and mail');
define('_ACCOUNT_MAILALL','All notifications are on');
define('_ACCOUNT_MAILHEAD','How much to show and what to send by mail');
define('_ACCOUNT_MAILHIDE','Other members do not see the address');
define('_ACCOUNT_MAILOFF','Some notifications are off');
define('_ACCOUNT_MAILSHOW','Other members see the address');
define('_ACCOUNT_MEMBER','Regular member');
define('_ACCOUNT_NEWSNOTE','The site newsletter comes to your address.');
define('_ACCOUNT_NEXT','To the next group: %s');
define('_ACCOUNT_NOPASS','No password');
define('_ACCOUNT_PERSON','Personal');
define('_ACCOUNT_PRIVACY','Privacy and appearance');
define('_ACCOUNT_PRIVHEAD','What others see and how the site looks to you');
define('_ACCOUNT_PSMAILNOTE','They are visible in the cabinet without a letter.');
define('_ACCOUNT_SAFE','Protected');
define('_ACCOUNT_SECTIONS','Settings sections');
define('_ACCOUNT_SETUPNOTE','Profile, avatar, password');
define('_ACCOUNT_SHOWN','Visible');
define('_ACCOUNT_STORYNOTE','How many entries the news and article lists show.');
define('_ACCOUNT_SYSTEM','System');
define('_ACCOUNT_THEMENOTE','How the site looks to you alone. The choice does not affect other users.');
define('_ACCOUNT_UNDO','Discard');
define('_ACCOUNT_UNSAVED','You have unsaved changes');
define('_ACCOUNT_VIEWNOTE','A hidden address is not shown even in your information.');
...
define('_OAUTHDONE','The external account has been linked to your profile!');
define('_OAUTHFAIL','Authorization via the external service failed. Please try to log in again.');
define('_OAUTHINTRO','You have successfully signed in via an external service. Link it to an existing account or create a new one.');
define('_OAUTHLAST','You cannot unlink the last login method of the account!');
define('_OAUTHLINK','Link to an existing account');
define('_OAUTHLINKT','Enter the login and password of your account to attach the external service sign-in to it.');
define('_OAUTHNEW','Create a new account');
define('_OAUTHNEWT','The account will be created without a password, sign-in works via the external service. A password can be set later via password recovery.');
define('_OAUTHNONE','No external services are linked.');
define('_OAUTHNOPW','No password is set. Create one via the password recovery procedure.');
define('_OAUTHOFF','The external account has been unlinked from your profile!');
define('_OAUTHTAB','External services');
define('_OAUTHTITLE','Completing sign-in');
...
define('_PASSESEND','Change of the password has been successfully made for the user %1$s to register on the site «%2$s».<br><br>Your login: %3$s<br>Link of an input: %4$s');
...
define('_PASSTEXT','After a successful change the new password takes effect at once and you stay signed in, so there is no need to log in again. If nothing works out, contact the site administrator to resolve this problem.');
