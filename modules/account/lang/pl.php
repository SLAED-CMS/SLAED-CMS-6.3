...
define('_ACCOUNT_FILLNOTE','Wypełniony profil jest lepiej widoczny w wyszukiwarce użytkowników.');
...
define('_ACCOUNT_LINKED','Powiązano %s');
define('_ACCOUNT_LOG','Dziennik konta');
...
define('_ACCOUNT_SIGNIN','Logowanie przez %s');
