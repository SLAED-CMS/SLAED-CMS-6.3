...
define('_ACCOUNT_BLOCKNOTE','Wyłączone menu nie jest pokazywane, ale tekst poniżej zostaje zachowany.');
define('_ACCOUNT_CLEAN','Brak ostrzeżeń');
define('_ACCOUNT_EXITNOTE','Zakończ sesję');
define('_ACCOUNT_FIELDS','Pola dodatkowe');
define('_ACCOUNT_FILLED','Wypełnienie profilu');
define('_ACCOUNT_FSMAILNOTE','List przychodzi na każdą odpowiedź w Twoim temacie.');
define('_ACCOUNT_HIDDEN','Ukryty');
define('_ACCOUNT_HUB','Wkład według modułów');
define('_ACCOUNT_ITEMS','Materiały');
define('_ACCOUNT_LEFT','Pozostałe pola');
define('_ACCOUNT_MAIL','Publikacje i poczta');
define('_ACCOUNT_MAILALL','Wszystkie powiadomienia są włączone');
define('_ACCOUNT_MAILHEAD','Ile pokazywać i o czym pisać na pocztę');
define('_ACCOUNT_MAILHIDE','Inni użytkownicy nie widzą adresu');
define('_ACCOUNT_MAILOFF','Część powiadomień jest wyłączona');
define('_ACCOUNT_MAILSHOW','Inni użytkownicy widzą adres');
define('_ACCOUNT_MEMBER','Zwykły uczestnik');
define('_ACCOUNT_NEWSNOTE','Biuletyn strony przychodzi na Twój adres.');
define('_ACCOUNT_NEXT','Do następnej grupy: %s');
define('_ACCOUNT_NOPASS','Bez hasła');
define('_ACCOUNT_PERSON','Osobiste');
define('_ACCOUNT_PRIVACY','Prywatność i wygląd');
define('_ACCOUNT_PRIVHEAD','Co widzą inni i jak strona wygląda dla Ciebie');
define('_ACCOUNT_PSMAILNOTE','W gabinecie są widoczne i bez listu.');
define('_ACCOUNT_SAFE','Chronione');
define('_ACCOUNT_SECTIONS','Sekcje ustawień');
define('_ACCOUNT_SETUPNOTE','Profil, awatar, hasło');
define('_ACCOUNT_SHOWN','Widoczny');
define('_ACCOUNT_STORYNOTE','Ile wpisów pokazują listy wiadomości i artykułów.');
define('_ACCOUNT_SYSTEM','System');
define('_ACCOUNT_THEMENOTE','Jak strona wygląda tylko dla Ciebie. Wybór nie wpływa na innych użytkowników.');
define('_ACCOUNT_UNDO','Odrzuć');
define('_ACCOUNT_UNSAVED','Są niezapisane zmiany');
define('_ACCOUNT_VIEWNOTE','Ukryty adres nie jest pokazywany nawet w Twoich informacjach.');
define('_ACCOUNT_WORK','Zawód');
define('_ACCOUNT_YEARS','Lat z projektem');
...
define('_OAUTHDONE','Konto zewnętrzne zostało powiązane z Twoim profilem!');
define('_OAUTHFAIL','Autoryzacja przez usługę zewnętrzną nie powiodła się. Spróbuj zalogować się ponownie.');
define('_OAUTHINTRO','Zalogowałeś się pomyślnie przez usługę zewnętrzną. Powiąż ją z istniejącym kontem lub utwórz nowe.');
define('_OAUTHLAST','Nie można odłączyć ostatniej metody logowania konta!');
define('_OAUTHLINK','Powiąż z istniejącym kontem');
define('_OAUTHLINKT','Podaj login i hasło swojego konta, aby powiązać z nim logowanie przez usługę zewnętrzną.');
define('_OAUTHNEW','Utwórz nowe konto');
define('_OAUTHNEWT','Konto zostanie utworzone bez hasła, logowanie odbywa się przez usługę zewnętrzną. Hasło można ustawić później przez odzyskiwanie hasła.');
define('_OAUTHNONE','Brak powiązanych usług zewnętrznych.');
define('_OAUTHNOPW','Hasło nie jest ustawione. Utwórz je przez procedurę odzyskiwania hasła.');
define('_OAUTHOFF','Konto zewnętrzne zostało odłączone od Twojego profilu!');
