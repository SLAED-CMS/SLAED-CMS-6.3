...
function autolink() {
	...
	if ($db->sql_numrows($result) > 0) {
		...
		$cont .= setArticleNumbers("pagenum", $conf['name'], $unum, $field, "id", "_auto_links", "", "hits != '0'", $confal['nump']);
	} else {
...
function add() {
	...
	$cont .= setTemplateWarning('warn', array('time' => '', 'url' => '', 'id' => 'info', 'text' => _A_LINKS_I));
