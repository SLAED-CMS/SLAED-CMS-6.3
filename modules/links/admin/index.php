...
function config(): void {
    ...
    $rows = [
        ...
        ['label_html' => _HOMCAT, 'label_id' => $labid = getFieldIds('', 'homcat')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'homcat', 'value' => (string)($conf['links']['homcat'] ?? 0), 'options' => $yesno])],
        ['label_html' => _VIEWCAT, 'label_id' => $labid = getFieldIds('', 'viewcat')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'viewcat', 'value' => (string)($conf['links']['viewcat'] ?? 0), 'options' => $yesno])],
        ['label_html' => _C_32, 'label_id' => $labid = getFieldIds('', 'catdesc')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'catdesc', 'value' => (string)($conf['links']['catdesc'] ?? 0), 'options' => $yesno])],
        ['label_html' => _C_15, 'label_id' => $labid = getFieldIds('', 'subcat')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'subcat', 'value' => (string)($conf['links']['subcat'] ?? 0), 'options' => $yesno])],
        ['label_html' => _ADDAMAIL, 'label_id' => $labid = getFieldIds('', 'addmail')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'addmail', 'value' => (string)($conf['links']['addmail'] ?? 0), 'options' => $yesno])],
        ['label_html' => _L_8, 'label_id' => $labid = getFieldIds('', 'add')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'add', 'value' => (string)($conf['links']['add'] ?? 0), 'options' => $yesno])],
        ['label_html' => _L_9, 'label_id' => $labid = getFieldIds('', 'addquest')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'addquest', 'value' => (string)($conf['links']['addquest'] ?? 0), 'options' => $yesno])],
        ['label_html' => _L_11, 'label_id' => $labid = getFieldIds('', 'broc')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'broc', 'value' => (string)($conf['links']['broc'] ?? 0), 'options' => $yesno])],
        ['label_html' => _L_12, 'label_id' => $labid = getFieldIds('', 'links')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'links', 'value' => (string)($conf['links']['links'] ?? 0), 'options' => $yesno])],
        ['label_html' => _C_37, 'label_id' => $labid = getFieldIds('', 'autor')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'autor', 'value' => (string)($conf['links']['autor'] ?? 0), 'options' => $yesno])],
        ['label_html' => _C_17, 'label_id' => $labid = getFieldIds('', 'date')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'date', 'value' => (string)($conf['links']['date'] ?? 0), 'options' => $yesno])],
        ['label_html' => _C_18, 'label_id' => $labid = getFieldIds('', 'read')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'read', 'value' => (string)($conf['links']['read'] ?? 0), 'options' => $yesno])],
        ['label_html' => _L_1, 'label_id' => $labid = getFieldIds('', 'hits')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'hits', 'value' => (string)($conf['links']['hits'] ?? 0), 'options' => $yesno])],
        ['label_html' => _C_19, 'label_id' => $labid = getFieldIds('', 'rate')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'rate', 'value' => (string)($conf['links']['rate'] ?? 0), 'options' => $yesno])],
        ['label_html' => _C_20, 'label_id' => $labid = getFieldIds('', 'letter')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'letter', 'value' => (string)($conf['links']['letter'] ?? 0), 'options' => $yesno])],
        ['label_html' => _PAGELINK, 'label_id' => $labid = getFieldIds('', 'link')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'link', 'value' => (string)($conf['links']['link'] ?? 0), 'options' => $yesno])],
    ];
    $cont .= $tpl->getHtmlPart('box', ['content_html' => $tpl->getHtmlPart('form', [
