...
function add(): void {
    ...
    $rows = [
        ...
        ['label_html' => _TEXT.':', 'field_html' => textarea('1', 'description', $description, 'links', '5', _TEXT, '1'), 'is_full' => true, 'field_unwrapped' => true],
        ['label_html' => _ENDTEXT.':', 'field_html' => textarea('2', 'bodytext', $bodytext, 'links', '15', _ENDTEXT, '0'), 'is_full' => true, 'field_unwrapped' => true],
        ['label_html' => $link.':', 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'url', 'name_attr' => 'site', 'value_attr' => $site, 'placeholder_text' => _URL])],
...
function info(): void {
    setTplAdminInfoPage([
        ...
        'tabs' => [_HOME, _ADD, _NEW, _BROCLINKS, _PREFERENCES, _INFO],
    ]);
}
