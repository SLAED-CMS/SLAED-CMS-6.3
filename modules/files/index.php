...
function add(): void {
    ...
    if ((is_user() && $conf['files']['add'] == 1) || (!is_user() && $conf['files']['addquest'] == 1)) {
        ...
        $fields .= $tpl->getHtmlFrag('form-field-row', ['label' => _SITE, 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'text', 'name_attr' => 'home', 'value_attr' => $home, 'maxlength_num' => 100, 'placeholder_text' => _SITE])]);
        $fields .= $extra;
