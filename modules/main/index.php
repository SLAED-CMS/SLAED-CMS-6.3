        ...
        <ul id="slider-head">
            ...
            <li>
                <div class="slide-cont">
                    ...
                    <p style="text-align: justify;">Интуитивно понятный интерфейс позволяет управлять сайтом так же просто, как работать с документами или почтой. При наличии хотя бы небольшого опыта и знания HTML сможете существенно изменить не только внешний вид, но и саму структуру сайта. Модульное наращивание позволяет инсталлировать на ваш сайт разного рода модули, блоки, темы оформления и разного рода дополнения.</p>
                    <a href="index.php?name=content&amp;op=view&amp;id=14" title="Управлять сайтом так же просто, как работать с документами на компьютере" class="sl_but_blue"><b>Подробнее</b></a>
                </div>
                <div class="slide-img"><img src="templates/lite/images/slide/slaed_1.jpg" alt="Управлять сайтом так же просто, как работать с документами на компьютере"></div>
            </li>
            <li>
                <div class="slide-cont">
                    <h2 class="font slide-title">Функциональность</h2>
                    <p style="text-align: justify;">К дополнению и без того широкого функционала системы существует масса дополнительных модулей, блоков, расширений и тем оформления, которые дополнят систему практически любым функционалом. Файловый архив проекта содержит более 685 дополнений от сторонних разработчиков. Система управления поставляется с открытым исходным кодом, что даёт неограниченные возможности модификации опытным пользователям.</p>
        ...
        <div class="wrp clrfix">
            <ul class="big-icons">
                <li>
                    ...
                    <h4 class="font"><a href="index.php?name=content&amp;op=view&amp;id=14" title="Управлять сайтом так же просто, как работать с документами на компьютере">Простота</a></h4>
                    <p>Интуитивно понятный интерфейс, простое управление сайтом, лёгкая модификация.</p>
                    <a href="index.php?name=content&amp;op=view&amp;id=14" title="Управлять сайтом так же просто, как работать с документами на компьютере" class="sl_but_read">Узнать больше</a>
                </li>
                <li>
