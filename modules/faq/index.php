...
function add(): void {
    ...
    if ((is_user() && $conf['faq']['add'] == 1) || (!is_user() && $conf['faq']['addquest'] == 1)) {
        ...
        $fields .= $tpl->getHtmlFrag('form-field-row', [
            'label_for' => 'f-title',
            'label' => _QUESTION,
            'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'text', 'name_attr' => 'title', 'input_id' => 'f-title', 'value_attr' => $title, 'maxlength_num' => 100, 'placeholder_text' => _QUESTION, 'is_required' => true]),
        ]);
        $fields .= $tpl->getHtmlFrag('form-field-row', [
            'label_for' => 'f-catid',
            'label' => _CATEGORY,
        ...
        $fields .= $tpl->getHtmlFrag('form-field-row', [
            ...
            'field_html' => getTplTextarea(['labelledby' => $labid, 'label' => _ANSWER,
                'id' => '1',
                'name' => 'hometext',
                'value' => $hometext,
                'mod' => $conf['name'],
