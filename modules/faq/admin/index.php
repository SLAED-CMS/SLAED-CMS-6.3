...
function add(): void {
    ...
    $rows = [
        ...
        ['label_for' => 'f-subject', 'label_html' => _TITLE.' / '._QUESTION, 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'text', 'name_attr' => 'subject', 'input_id' => 'f-subject', 'value_attr' => $subject, 'maxlength_num' => 255, 'is_required' => true])],
        ...
        ['label_html' => _ANSWER, 'label_id' => $labid = getFieldIds('', 'hometext')['label'], 'field_html' => getTplTextarea(['labelledby' => $labid, 'label' => _ANSWER,
...
function config(): void {
    ...
    $rows = [
        ['label_for' => 'f-defis', 'label_html' => _CDEFIS, 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'text', 'name_attr' => 'defis', 'input_id' => 'f-defis', 'value_attr' => urldecode($conf['faq']['defis'] ?? ''), 'is_config' => true])],
        ['label_for' => 'f-linknum', 'label_html' => _PAGELINKNUM, 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'number', 'name_attr' => 'linknum', 'input_id' => 'f-linknum', 'value_attr' => (string)($conf['faq']['linknum'] ?? 0), 'is_config' => true])],
        ['label_for' => 'f-listnum', 'label_html' => _C_13, 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'number', 'name_attr' => 'listnum', 'input_id' => 'f-listnum', 'value_attr' => (string)($conf['faq']['listnum'] ?? 0), 'is_config' => true])],
        ['label_for' => 'f-num', 'label_html' => _C_33, 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'number', 'name_attr' => 'num', 'input_id' => 'f-num', 'value_attr' => (string)($conf['faq']['num'] ?? 0), 'is_config' => true])],
        ['label_for' => 'f-anum', 'label_html' => _C_34, 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'number', 'name_attr' => 'anum', 'input_id' => 'f-anum', 'value_attr' => (string)($conf['faq']['anum'] ?? 0), 'is_config' => true])],
        ['label_for' => 'f-nump', 'label_html' => _C_35, 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'number', 'name_attr' => 'nump', 'input_id' => 'f-nump', 'value_attr' => (string)($conf['faq']['nump'] ?? 0), 'is_config' => true])],
        ['label_for' => 'f-anump', 'label_html' => _C_36, 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'number', 'name_attr' => 'anump', 'input_id' => 'f-anump', 'value_attr' => (string)($conf['faq']['anump'] ?? 0), 'is_config' => true])],
        ['label_html' => _HOMCAT, 'label_id' => $labid = getFieldIds('', 'homcat')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'homcat', 'value' => (string)($conf['faq']['homcat'] ?? 0), 'options' => $yesno])],
        ['label_html' => _VIEWCAT, 'label_id' => $labid = getFieldIds('', 'viewcat')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'viewcat', 'value' => (string)($conf['faq']['viewcat'] ?? 0), 'options' => $yesno])],
        ['label_html' => _C_32, 'label_id' => $labid = getFieldIds('', 'catdesc')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'catdesc', 'value' => (string)($conf['faq']['catdesc'] ?? 0), 'options' => $yesno])],
        ['label_html' => _C_15, 'label_id' => $labid = getFieldIds('', 'subcat')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'subcat', 'value' => (string)($conf['faq']['subcat'] ?? 0), 'options' => $yesno])],
        ['label_html' => _ADDAMAIL, 'label_id' => $labid = getFieldIds('', 'addmail')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'addmail', 'value' => (string)($conf['faq']['addmail'] ?? 0), 'options' => $yesno])],
        ['label_html' => _C_39, 'label_id' => $labid = getFieldIds('', 'add')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'add', 'value' => (string)($conf['faq']['add'] ?? 0), 'options' => $yesno])],
        ['label_html' => _C_40, 'label_id' => $labid = getFieldIds('', 'addquest')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'addquest', 'value' => (string)($conf['faq']['addquest'] ?? 0), 'options' => $yesno])],
        ['label_html' => _C_37, 'label_id' => $labid = getFieldIds('', 'autor')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'autor', 'value' => (string)($conf['faq']['autor'] ?? 0), 'options' => $yesno])],
        ['label_html' => _C_17, 'label_id' => $labid = getFieldIds('', 'date')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'date', 'value' => (string)($conf['faq']['date'] ?? 0), 'options' => $yesno])],
        ['label_html' => _C_18, 'label_id' => $labid = getFieldIds('', 'read')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'read', 'value' => (string)($conf['faq']['read'] ?? 0), 'options' => $yesno])],
        ['label_html' => _C_19, 'label_id' => $labid = getFieldIds('', 'rate')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'rate', 'value' => (string)($conf['faq']['rate'] ?? 0), 'options' => $yesno])],
        ['label_html' => _C_20, 'label_id' => $labid = getFieldIds('', 'letter')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'letter', 'value' => (string)($conf['faq']['letter'] ?? 0), 'options' => $yesno])],
        ['label_html' => _PAGELINK, 'label_id' => $labid = getFieldIds('', 'link')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'link', 'value' => (string)($conf['faq']['link'] ?? 0), 'options' => $yesno])],
    ];
    $cont .= $tpl->getHtmlPart('box', ['content_html' => $tpl->getHtmlPart('form', [
