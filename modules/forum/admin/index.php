...
function config(): void {
    ...
    $rows = [
        ...
        ['label_for' => 'f-letter', 'label_html' => $tpl->getHtmlFrag('label-hint', ['label' => _COMLETTER, 'hint' => _CONFINES]), 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'number', 'name_attr' => 'letter', 'input_id' => 'f-letter', 'value_attr' => (string)($conf['forum']['letter'] ?? 0), 'is_config' => true])],
