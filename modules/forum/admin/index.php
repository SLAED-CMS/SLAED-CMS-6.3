...
function config(): void {
    ...
    $rows = [
        ['label_for' => 'f-defis', 'label_html' => _CDEFIS, 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'text', 'name_attr' => 'defis', 'input_id' => 'f-defis', 'value_attr' => urldecode($conf['forum']['defis'] ?? ''), 'is_config' => true])],
        ['label_for' => 'f-listnum', 'label_html' => _FO_1, 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'number', 'name_attr' => 'listnum', 'input_id' => 'f-listnum', 'value_attr' => (string)($conf['forum']['listnum'] ?? 0), 'is_config' => true])],
        ['label_for' => 'f-pop', 'label_html' => _FO_2, 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'number', 'name_attr' => 'pop', 'input_id' => 'f-pop', 'value_attr' => (string)($conf['forum']['pop'] ?? 0), 'is_config' => true])],
        ['label_for' => 'f-letter', 'label_html' => _COMLETTER, 'hint_html' => _CONFINES, 'hint_id' => $hntid = getFieldIds('f-letter')['hint'], 'field_html' => $tpl->getHtmlFrag('input', ['describedby' => $hntid, 'itype' => 'number', 'name_attr' => 'letter', 'input_id' => 'f-letter', 'value_attr' => (string)($conf['forum']['letter'] ?? 0), 'is_config' => true])],
        ['label_for' => 'f-num', 'label_html' => _C_33, 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'number', 'name_attr' => 'num', 'input_id' => 'f-num', 'value_attr' => (string)($conf['forum']['num'] ?? 0), 'is_config' => true])],
        ['label_for' => 'f-pnum', 'label_html' => _C_35, 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'number', 'name_attr' => 'pnum', 'input_id' => 'f-pnum', 'value_attr' => (string)($conf['forum']['pnum'] ?? 0), 'is_config' => true])],
        ['label_for' => 'f-recycle', 'label_html' => _FO_5, 'field_html' => $tpl->getHtmlFrag('select', ['name_attr' => 'recycle', 'selectid' => 'f-recycle', 'is_config' => true, 'options_html' => $recycleopts])],
        ['label_for' => 'f-sort', 'label_html' => _SORT, 'field_html' => $tpl->getHtmlFrag('select', ['name_attr' => 'sort', 'selectid' => 'f-sort', 'is_config' => true, 'options_html' => $sortopts])],
        ['label_for' => 'f-anonpost', 'label_html' => _FO_6, 'field_html' => $tpl->getHtmlFrag('select', ['name_attr' => 'anonpost', 'selectid' => 'f-anonpost', 'is_config' => true, 'options_html' => $anonopts])],
        ['label_html' => _FO_7, 'label_id' => $labid = getFieldIds('', 'add')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'add', 'value' => (string)($conf['forum']['add'] ?? 0), 'options' => $yesno])],
        ['label_html' => _FO_8, 'label_id' => $labid = getFieldIds('', 'qreply')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'qreply', 'value' => (string)($conf['forum']['qreply'] ?? 0), 'options' => $yesno])],
        ['label_html' => _FO_9, 'label_id' => $labid = getFieldIds('', 'ledit')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'ledit', 'value' => (string)($conf['forum']['ledit'] ?? 0), 'options' => $yesno])],
        ['label_html' => _FO_10, 'label_id' => $labid = getFieldIds('', 'addmail')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'addmail', 'value' => (string)($conf['forum']['addmail'] ?? 0), 'options' => $yesno])],
        ['label_html' => _VPRIVAT, 'label_id' => $labid = getFieldIds('', 'privat')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'privat', 'value' => (string)($conf['forum']['privat'] ?? 0), 'options' => $yesno])],
        ['label_html' => _VPROFIL, 'label_id' => $labid = getFieldIds('', 'profil')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'profil', 'value' => (string)($conf['forum']['profil'] ?? 0), 'options' => $yesno])],
        ['label_html' => _VWEB, 'label_id' => $labid = getFieldIds('', 'web')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'web', 'value' => (string)($conf['forum']['web'] ?? 0), 'options' => $yesno])],
    ];
