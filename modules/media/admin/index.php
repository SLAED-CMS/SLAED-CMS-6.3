...
function add(): void {
    ...
    $mid = $id;
    if ($mid) {
        $result = $db->getSqlQuery('SELECT m.cid, m.name, m.title, m.subtitle, m.year, m.director, m.roles, m.intro, m.author, m.duration, m.lang, m.note, m.format, m.quality, m.size, m.released, m.links, m.time, m.ihome, m.acomm, u.name FROM '.PREFIX_DB.'_media AS m LEFT JOIN '.PREFIX_DB.'_users AS u ON (m.uid = u.id) WHERE m.id = :id', ['id' => $mid]);
    ...
    $rows = [
        ...
        ['label_for' => 'f-title', 'label_html' => _MTITLE, 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'text', 'name_attr' => 'title', 'input_id' => 'f-title', 'value_attr' => $title, 'maxlength_num' => 255, 'is_required' => true])],
        ['label_for' => 'f-subtitle', 'label_html' => _MSUBTITLE, 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'text', 'name_attr' => 'subtitle', 'input_id' => 'f-subtitle', 'value_attr' => $subtitle, 'maxlength_num' => 255])],
        ['label_for' => 'f-cid', 'label_html' => _CATEGORY, 'field_html' => $tpl->getHtmlFrag('select', ['name_attr' => 'cid', 'selectid' => 'f-cid', 'options_html' => $catopts])],
        ['label_for' => 'f-year', 'label_html' => _MYEAR, 'field_html' => $tpl->getHtmlFrag('select', ['name_attr' => 'year', 'selectid' => 'f-year', 'options_html' => $yearopts])],
        ['label_for' => 'f-director', 'label_html' => _MDIRECTOR, 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'text', 'name_attr' => 'director', 'input_id' => 'f-director', 'value_attr' => $director])],
        ['label_for' => 'f-roles', 'label_html' => _MROLES, 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'text', 'name_attr' => 'roles', 'input_id' => 'f-roles', 'value_attr' => $roles])],
        ['label_html' => _DESCRIPTION, 'label_id' => $labid = getFieldIds('', 'description')['label'], 'field_html' => getTplTextarea(['labelledby' => $labid, 'label' => _DESCRIPTION,
        ...
        ['label_for' => 'f-createdby', 'label_html' => _MCREATEDBY, 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'text', 'name_attr' => 'createdby', 'input_id' => 'f-createdby', 'value_attr' => $createdby])],
        ['label_for' => 'f-duration', 'label_html' => _MDURATION, 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'text', 'name_attr' => 'duration', 'input_id' => 'f-duration', 'value_attr' => $duration])],
        ['label_for' => 'f-lang', 'label_html' => _LANGUAGE, 'field_html' => $tpl->getHtmlFrag('select', ['name_attr' => 'lang', 'selectid' => 'f-lang', 'options_html' => $langopts])],
        ['label_html' => _NOTE, 'label_id' => $labid = getFieldIds('', 'note')['label'], 'field_html' => getTplTextarea(['labelledby' => $labid, 'label' => _NOTE,
            'id' => '2', 'name' => 'note', 'value' => $note, 'mod' => 'media', 'store' => 'media.note', 'rows' => '10', 'placeholder' => _NOTE, 'required' => '0',
        ]), 'is_full' => true, 'field_unwrapped' => true],
        ['label_for' => 'f-format', 'label_html' => _MFORMAT, 'field_html' => $tpl->getHtmlFrag('select', ['name_attr' => 'format', 'selectid' => 'f-format', 'options_html' => $formatopts])],
        ['label_for' => 'f-quality', 'label_html' => _MQUALITY, 'field_html' => $tpl->getHtmlFrag('select', ['name_attr' => 'quality', 'selectid' => 'f-quality', 'options_html' => $qualityopts])],
        ['label_for' => 'f-size', 'label_html' => _MSIZE, 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'text', 'name_attr' => 'size', 'input_id' => 'f-size', 'value_attr' => $size])],
        ['label_for' => 'f-released', 'label_html' => _MRELEASED, 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'text', 'name_attr' => 'released', 'input_id' => 'f-released', 'value_attr' => $released])],
        ...
        ['label_html' => _PUBHOME, 'label_id' => $labid = getFieldIds('', 'ihome')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'ihome', 'value' => (string)$ihome, 'options' => [['value' => '1', 'label' => _YES], ['value' => '0', 'label' => _NO]]])],
...
function save(): void {
    ...
    if (!$iswarn) {
        ...
        if (!$stop && $posttype === 'save') {
            ...
            if ($mid) {
                setContentActive('_media', [$mid], 25);
                $db->getSqlQuery('UPDATE '.PREFIX_DB.'_media SET cid = :cid, uid = :uid, name = :name, title = :title, subtitle = :subtitle, year = :year, director = :director, roles = :roles, intro = :intro, author = :createdby, duration = :duration, lang = :lang, note = :note, format = :format, quality = :quality, size = :size, released = :released, links = :links, time = :time, ihome = :ihome, acomm = :acomm WHERE id = :mid', ['cid' => $cid, 'uid' => $postid, 'name' => $postname, 'title' => $title, 'subtitle' => $subtitle, 'year' => $year, 'director' => $director, 'roles' => $roles, 'intro' => $description, 'createdby' => $createdby, 'duration' => $duration, 'lang' => $lang, 'note' => $note, 'format' => $format, 'quality' => $quality, 'size' => $size, 'released' => $released, 'links' => $links, 'time' => $mdate, 'ihome' => $ihome, 'acomm' => $acomm, 'mid' => $mid]);
            } else {
                $ip = getip();
...
function approve(): void {
    ...
    $iswarn = !checkSiteToken();
    if (!$iswarn && $id) setContentActive('_media', [$id], 25);
...
function config(): void {
    ...
    $rows = [
        ['label_for' => 'f-defis', 'label_html' => _CDEFIS, 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'text', 'name_attr' => 'defis', 'input_id' => 'f-defis', 'value_attr' => urldecode($conf['media']['defis'] ?? ''), 'is_config' => true])],
        ['label_for' => 'f-linknum', 'label_html' => _PAGELINKNUM, 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'number', 'name_attr' => 'linknum', 'input_id' => 'f-linknum', 'value_attr' => (string)($conf['media']['linknum'] ?? 10), 'is_config' => true])],
        ['label_for' => 'f-listnum', 'label_html' => _C_13, 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'number', 'name_attr' => 'listnum', 'input_id' => 'f-listnum', 'value_attr' => (string)($conf['media']['listnum'] ?? 10), 'is_config' => true])],
        ['label_for' => 'f-num', 'label_html' => _C_33, 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'number', 'name_attr' => 'num', 'input_id' => 'f-num', 'value_attr' => (string)($conf['media']['num'] ?? 25), 'is_config' => true])],
        ['label_for' => 'f-anum', 'label_html' => _C_34, 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'number', 'name_attr' => 'anum', 'input_id' => 'f-anum', 'value_attr' => (string)($conf['media']['anum'] ?? 25), 'is_config' => true])],
        ['label_for' => 'f-nump', 'label_html' => _C_35, 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'number', 'name_attr' => 'nump', 'input_id' => 'f-nump', 'value_attr' => (string)($conf['media']['nump'] ?? 10), 'is_config' => true])],
        ['label_for' => 'f-anump', 'label_html' => _C_36, 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'number', 'name_attr' => 'anump', 'input_id' => 'f-anump', 'value_attr' => (string)($conf['media']['anump'] ?? 10), 'is_config' => true])],
        ['label_for' => 'f-lang', 'label_html' => _M_1, 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'text', 'name_attr' => 'lang', 'input_id' => 'f-lang', 'value_attr' => $conf['media']['lang'] ?? '', 'is_config' => true])],
        ['label_for' => 'f-format', 'label_html' => _M_2, 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'text', 'name_attr' => 'format', 'input_id' => 'f-format', 'value_attr' => $conf['media']['format'] ?? '', 'is_config' => true])],
        ['label_for' => 'f-quality', 'label_html' => _M_3, 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'text', 'name_attr' => 'quality', 'input_id' => 'f-quality', 'value_attr' => $conf['media']['quality'] ?? '', 'is_config' => true])],
        ['label_for' => 'f-links', 'label_html' => _M_4, 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'number', 'name_attr' => 'links', 'input_id' => 'f-links', 'value_attr' => (string)($conf['media']['links'] ?? 0), 'is_config' => true])],
        ['label_for' => 'f-mdefis', 'label_html' => _DEFIS, 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'text', 'name_attr' => 'mdefis', 'input_id' => 'f-mdefis', 'value_attr' => urldecode($conf['media']['mdefis'] ?? ''), 'is_config' => true])],
        ['label_html' => _HOMCAT, 'label_id' => $labid = getFieldIds('', 'homcat')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'homcat', 'value' => (string)($conf['media']['homcat'] ?? 0), 'options' => $yesno])],
        ['label_html' => _VIEWCAT, 'label_id' => $labid = getFieldIds('', 'viewcat')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'viewcat', 'value' => (string)($conf['media']['viewcat'] ?? 0), 'options' => $yesno])],
        ['label_html' => _C_32, 'label_id' => $labid = getFieldIds('', 'catdesc')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'catdesc', 'value' => (string)($conf['media']['catdesc'] ?? 0), 'options' => $yesno])],
        ['label_html' => _C_15, 'label_id' => $labid = getFieldIds('', 'subcat')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'subcat', 'value' => (string)($conf['media']['subcat'] ?? 0), 'options' => $yesno])],
        ['label_html' => _ADDAMAIL, 'label_id' => $labid = getFieldIds('', 'addmail')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'addmail', 'value' => (string)($conf['media']['addmail'] ?? 0), 'options' => $yesno])],
        ['label_html' => _M_7, 'label_id' => $labid = getFieldIds('', 'add')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'add', 'value' => (string)($conf['media']['add'] ?? 0), 'options' => $yesno])],
        ['label_html' => _M_8, 'label_id' => $labid = getFieldIds('', 'addquest')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'addquest', 'value' => (string)($conf['media']['addquest'] ?? 0), 'options' => $yesno])],
        ['label_html' => _M_9, 'label_id' => $labid = getFieldIds('', 'broc')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'broc', 'value' => (string)($conf['media']['broc'] ?? 0), 'options' => $yesno])],
        ['label_html' => _M_10, 'label_id' => $labid = getFieldIds('', 'hide')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'hide', 'value' => (string)($conf['media']['hide'] ?? 0), 'options' => $yesno])],
        ['label_html' => _C_37, 'label_id' => $labid = getFieldIds('', 'autor')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'autor', 'value' => (string)($conf['media']['autor'] ?? 0), 'options' => $yesno])],
        ['label_html' => _C_17, 'label_id' => $labid = getFieldIds('', 'date')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'date', 'value' => (string)($conf['media']['date'] ?? 0), 'options' => $yesno])],
        ['label_html' => _C_18, 'label_id' => $labid = getFieldIds('', 'read')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'read', 'value' => (string)($conf['media']['read'] ?? 0), 'options' => $yesno])],
        ['label_html' => _C_19, 'label_id' => $labid = getFieldIds('', 'rate')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'rate', 'value' => (string)($conf['media']['rate'] ?? 0), 'options' => $yesno])],
        ['label_html' => _C_20, 'label_id' => $labid = getFieldIds('', 'letter')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'letter', 'value' => (string)($conf['media']['letter'] ?? 0), 'options' => $yesno])],
        ['label_html' => _PAGELINK, 'label_id' => $labid = getFieldIds('', 'link')['label'], 'field_html' => getTplRadioGroup(['labelledby' => $labid, 'name' => 'link', 'value' => (string)($conf['media']['link'] ?? 0), 'options' => $yesno])],
    ];
    $cont .= $tpl->getHtmlPart('box', ['content_html' => $tpl->getHtmlPart('form', [
