...
function config(): void {
    ...
    $rows = [
        ...
        ['label_html' => _MA_12, 'label_id' => $labid = getFieldIds('', 'info')['label'], 'field_html' => getTplTextarea(['labelledby' => $labid, 'label' => _MA_12,
            'id' => '2', 'name' => 'info', 'value' => (string)($conf['money']['info'] ?? ''), 'mod' => 'all', 'store' => 'config', 'rows' => 5, 'placeholder' => _MA_12,
            'required' => '1',
        ]), 'is_full' => true],
        ['label_html' => _MA_13, 'label_id' => $labid = getFieldIds('', 'sendinfo')['label'], 'field_html' => getTplTextarea(['labelledby' => $labid, 'label' => _MA_13,
            'id' => '3', 'name' => 'sendinfo', 'value' => (string)($conf['money']['sendinfo'] ?? ''), 'mod' => 'all', 'store' => 'config', 'rows' => 5, 'placeholder' => _MA_13,
            'required' => '1',
        ]), 'is_full' => true],
        ['label_html' => _MA_14, 'label_id' => $labid = getFieldIds('', 'autor')['label'], 'field_html' => getTplTextarea(['labelledby' => $labid, 'label' => _MA_14,
