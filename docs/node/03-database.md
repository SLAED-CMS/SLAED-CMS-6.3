...
Модель ниже является основой доработки. До повторного утверждения нужно завершить хранение голосов общего Rating, протокол согласованности типа с файловой конфигурацией, конкурентную проверку дерева и обновление данных общих подсистем. Критерии дизайна отделены от будущей проверки установленной схемы.
