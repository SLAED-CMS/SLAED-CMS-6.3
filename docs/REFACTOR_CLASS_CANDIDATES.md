...
Источник: инвентаризация `core/system.php`, сверенная с существующими
сервис-классами в `core/classes/`.

## Контекст

`core/system.php` — крупный процедурный runtime-файл. Каждый существующий класс
...
- **Почему класс**: четыре буфера плюс три карты живут через всю функцию. Класс
  ...
  чище и сократил бы риск ошибок состояния внутри длинной функции.
...
- **Scheduler** — текущая реализация процедурная и держит состояние в конфиге и
  runtime-файлах, а не в долгоживущем объекте.
