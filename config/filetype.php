...
return [
    'filetype' => [
        ...
        'mp4' => '<video controls preload="metadata" width="[width]" height="[height]" src="[src]" title="[title]"></video>',
        'oga' => '<audio controls preload="metadata" src="[src]" title="[title]"></audio>',
        'ogg' => '<audio controls preload="metadata" src="[src]" title="[title]"></audio>',
        'opus' => '<audio controls preload="metadata" src="[src]" title="[title]"></audio>',
        'pdf' => '<object data="[src]" type="application/pdf" width="[width]" height="[height]"><a href="[src]">[title]</a></object>',
        'png' => '<a rel="[rel]" title="[title]" href="[src]" class="sl-attach sl-attach-[align]"><img src="[tsrc]" style="max-width:[twidth]px" alt="[title]" loading="lazy"></a>',
        'rar' => '<a href="[src]" target="_blank" rel="noopener" title="[title]">[title]</a>',
