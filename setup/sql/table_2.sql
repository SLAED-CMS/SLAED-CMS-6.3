...
CREATE TABLE IF NOT EXISTS `{prefix}_auto_links` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `{prefix}_clients` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `{prefix}_clients_down` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `id_clients` INT UNSIGNED NOT NULL DEFAULT 0,
  `id_product` INT UNSIGNED NOT NULL DEFAULT 0,
  `regdate` INT UNSIGNED NOT NULL DEFAULT 0,
  `enddate` INT UNSIGNED NOT NULL DEFAULT 0,
  `info` VARCHAR(255) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `{prefix}_content` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `{prefix}_favorites` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `uid` INT UNSIGNED NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `{prefix}_forum` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `{prefix}_help` (
...
CREATE TABLE IF NOT EXISTS `{prefix}_money` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `id_partners` INT UNSIGNED NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `{prefix}_newsletter` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `title` VARCHAR(50) NOT NULL,
  `content` TEXT,
  `mails` MEDIUMTEXT,
...
CREATE TABLE IF NOT EXISTS `{prefix}_privat` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `{prefix}_rating` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `{prefix}_voting` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `modul` VARCHAR(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `{prefix}_whois` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
