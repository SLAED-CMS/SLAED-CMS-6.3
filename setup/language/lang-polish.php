...
define("_CDEFAULT","W razie wątpliwości można wybrać to pole, zostaw go, który został wyznaczony przez domyślne.");
...
define("_CONF_5","Typ bazy danych");
define("_CONF_6","Silnik przechowywania bazy danych");
define("_CONF_7","Kodowanie bazy danych");
define("_CONF_8","Porównanie kodowania tabeli bazy danych");
...
define("_PHPSETUP","Wersja PHP zainstalowany na Twoim serwerze nie spełnia minimalne wymagania systemu, powinna być nie niższa PHP 5.6!");
