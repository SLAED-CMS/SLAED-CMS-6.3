...
define("_CONF_6","Database storage engine");
define("_CONF_7","Database encoding");
define("_CONF_8","Database table encoding comparison");
...
define("_PHPSETUP","Version PHP established on your server mismatches minimal requirements of system, it should be not below PHP 5.6!");
