...
define("_CDEFAULT","Si vous avez des doutes dans le choix, laissez les paramètres par défaut.");
...
define("_CONF_5","Type de base de données");
define("_CONF_6","Moteur de stockage de base de données");
define("_CONF_7","Encodage de la base de données");
define("_CONF_8","Comparaison d'encodage de table de base de données");
...
define("_PHPSETUP","La version de PHP installée sur Votre serveur ne répond pas aux exigences minimales du système, il devrait être en dessous de PHP 5.6!");
