...
define('_PHPSETUP','Die eingerichtete PHP Version auf Ihren Server entspricht den minimalen Forderungen des Systems nicht, sie soll nicht niedriger als PHP 8.1 sein!');
