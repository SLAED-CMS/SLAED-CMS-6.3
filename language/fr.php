...
define('_CHLOG_AUTHOR_PH','p. ex. Eduard Laas');
...
define('_CHLOG_ERR_GH_API','Erreur API GitHub : HTTP %s');
define('_CHLOG_ERR_GH_API_JSON',"La réponse de l'API GitHub n'a pas pu être analysée.");
define('_CHLOG_ERR_GH_CONF',"Le propriétaire/le dépôt GitHub n'est pas configuré.");
define('_CHLOG_ERR_GH_CONNECT','Connexion à GitHub échouée.');
define('_CHLOG_ERR_GH_JSON',"Le JSON GitHub n'a pas pu être analysé.");
define('_CHLOG_ERR_GIT_CHDIR','Impossible de changer vers le répertoire git : %s');
define('_CHLOG_ERR_GIT_CMD','La commande git a échoué (code : %s)');
define('_CHLOG_ERR_GIT_MISSING','Dépôt git introuvable : %s');
...
define('_CHLOG_FILE_PH','p. ex. config/config.php');
define('_CHLOG_FILES','fichier(s)');
define('_CHLOG_FILTER','Filtre et recherche');
define('_CHLOG_FILTER_BTN','Filtrer');
define('_CHLOG_FILTERED','Filtré');
...
define('_CHLOG_SEARCH_PH','Rechercher dans le message du commit...');
