...
define('_CHLOG_ERR_GH_API','GitHub API Fehler: HTTP %s');
define('_CHLOG_ERR_GH_API_JSON','GitHub API Antwort konnte nicht verarbeitet werden.');
define('_CHLOG_ERR_GH_CONF','GitHub Owner/Repository ist nicht konfiguriert.');
define('_CHLOG_ERR_GH_CONNECT','Verbindung zu GitHub fehlgeschlagen.');
define('_CHLOG_ERR_GH_JSON','GitHub JSON konnte nicht verarbeitet werden.');
define('_CHLOG_ERR_GIT_CHDIR','Wechsel in das Git-Verzeichnis fehlgeschlagen: %s');
define('_CHLOG_ERR_GIT_CMD','Git-Befehl fehlgeschlagen (Code: %s)');
define('_CHLOG_ERR_GIT_MISSING','Git-Repository nicht gefunden: %s');
...
define('_ERROR404','Fehler %1$s, Seite nicht gefunden! Wahrscheinlich die Seite ist nicht vorhanden, oder Sie ist vorübergehend nicht verfügbar. Vielleicht, Sie ging auf den veralteten Link oder versehentlich bei der falschen Adresse. Sie werden nun umgeleitet auf die Hauptseite der Website, wenn dies nicht der Fall, verwenden Sie das <a href="%2$s">Link</a>.');
