...
define('_CHLOG_ERR_GH_API','Помилка GitHub API: HTTP %s');
define('_CHLOG_ERR_GH_API_JSON','Відповідь GitHub API не вдалося обробити.');
define('_CHLOG_ERR_GH_CONF','GitHub owner/repository не налаштовано.');
define('_CHLOG_ERR_GH_CONNECT','Не вдалося підключитися до GitHub.');
define('_CHLOG_ERR_GH_JSON','Не вдалося обробити JSON GitHub.');
define('_CHLOG_ERR_GIT_CHDIR','Не вдалося перейти до git-каталогу: %s');
define('_CHLOG_ERR_GIT_CMD','Команда git завершилась з помилкою (код: %s)');
define('_CHLOG_ERR_GIT_MISSING','Git-репозиторій не знайдено: %s');
define('_CHLOG_ERR_NO_COMMITS','Коміти не знайдено.');
define('_CHLOG_ERR_TOKEN','Перевірка безпеки не пройдена. Оновіть форму і спробуйте ще раз.');
...
define('_CHLOG_SEARCH','Пошуковий запит');
define('_CHLOG_SEARCH_PH','Пошук у повідомленні коміту...');
...
define('_ERROR404','Помилка %1$s, сторінка не знайдена! Найвірогідніше сторінки не існує або вона тимчасово недоступна. Можливо, ви перейшли за застарілим посиланням або випадково помилилися адресою. Зараз ви будете перенаправлені на головну сторінку сайту, якщо цього не станеться, скористайтеся даною <a href="%2$s">посиланням</a>.');
