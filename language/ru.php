...
define('_CHLOG_COMMITS','коммитов');
define('_CHLOG_COMMITS_REPO','доступных коммитов');
define('_CHLOG_DATE','Дата');
define('_CHLOG_DATE_FROM','Дата от');
define('_CHLOG_DATE_TO','Дата до');
define('_CHLOG_ERR_GH_API','Ошибка GitHub API: HTTP %s');
define('_CHLOG_ERR_GH_API_JSON','Ответ GitHub API не удалось обработать.');
define('_CHLOG_ERR_GH_CONF','GitHub owner/repository не настроен.');
define('_CHLOG_ERR_GH_CONNECT','Не удалось подключиться к GitHub.');
define('_CHLOG_ERR_GH_JSON','Не удалось обработать JSON GitHub.');
define('_CHLOG_ERR_GIT_CHDIR','Не удалось перейти в git-каталог: %s');
define('_CHLOG_ERR_GIT_CMD','Команда git завершилась с ошибкой (код: %s)');
define('_CHLOG_ERR_GIT_MISSING','Git-репозиторий не найден: %s');
...
define('_CHLOG_RESET_BTN','Сбросить');
define('_CHLOG_SEARCH','Поисковый запрос');
define('_CHLOG_SEARCH_PH','Поиск по сообщению коммита...');
...
define('_CHLOG_THIS_WEEK','На этой неделе');
...
define('_ERROR404','Ошибка %1$s, страница не найдена! Вероятней всего страницы не существует либо она временно не доступна. Возможно, вы перешли по устаревшей ссылке или случайно ошиблись адресом. Сейчас вы будете перенаправлены на главную страницу сайта, если этого не произойдёт, воспользуйтесь данной <a href="%2$s">ссылкой</a>.');
...
define('_S_FAVORITEN','В закладки');
