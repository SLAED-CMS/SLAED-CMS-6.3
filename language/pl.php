...
define('_CHLOG_COMMITS','Commitów');
define('_CHLOG_COMMITS_REPO','dostepnych commitow');
define('_CHLOG_DATE','Data');
define('_CHLOG_DATE_FROM','Data od');
define('_CHLOG_DATE_TO','Data do');
define('_CHLOG_ERR_GH_API','Błąd API GitHub: HTTP %s');
define('_CHLOG_ERR_GH_API_JSON','Nie udało się przetworzyć odpowiedzi API GitHub.');
define('_CHLOG_ERR_GH_CONF','Właściciel/repozytorium GitHub nie jest skonfigurowane.');
define('_CHLOG_ERR_GH_CONNECT','Połączenie z GitHub nie powiodło się.');
define('_CHLOG_ERR_GH_JSON','Nie udało się przetworzyć JSON GitHub.');
define('_CHLOG_ERR_GIT_CHDIR','Nie udało się przejść do katalogu git: %s');
define('_CHLOG_ERR_GIT_CMD','Polecenie git nie powiodło się (kod: %s)');
define('_CHLOG_ERR_GIT_MISSING','Nie znaleziono repozytorium git: %s');
define('_CHLOG_ERR_NO_COMMITS','Nie znaleziono commitów.');
define('_CHLOG_ERR_TOKEN','Weryfikacja zabezpieczenia nie powiodła się. Odswiez formularz i spróbuj ponownie.');
...
define('_CHLOG_SEARCH','Szukana fraza');
define('_CHLOG_SEARCH_PH','Przeszukaj wiadomość commita...');
...
define('_CHLOG_THIS_WEEK','W tym tygodniu');
...
define('_ERROR404','Błąd %1$s, nie znaleziono strony! Prawdopodobnie strona nie istnieje lub jest tymczasowo niedostępna. Być może przeszli na przestarzałej link lub przypadkowo pomyłka. Teraz zostaniesz przekierowany na stronę główną, jeśli do tego nie dojdzie, skorzystaj z tej <a href="%2$s">link</a>.');
