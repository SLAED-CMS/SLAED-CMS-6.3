...
function config(): void {
    ...
    $rows = [
        ...
        ['label_for' => 'f-letter', 'label_html' => $tpl->getHtmlFrag('label-hint', ['label' => _COMLETTER, 'hint' => _CONFINES]), 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'number', 'name_attr' => 'letter', 'input_id' => 'f-letter', 'value_attr' => (string)$conf['comments']['letter']])],
        ...
        ['label_for' => 'f-send', 'label_html' => $tpl->getHtmlFrag('label-hint', ['label' => _CSEND, 'hint' => _CONFINES]), 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'number', 'name_attr' => 'send', 'input_id' => 'f-send', 'value_attr' => (string)$conf['comments']['send']])],
        ...
        ['label_for' => 'f-link', 'label_html' => $tpl->getHtmlFrag('label-hint', ['label' => _NOLINKP, 'hint' => _NOAUM]), 'field_html' => $tpl->getHtmlFrag('select', ['name_attr' => 'link', 'selectid' => 'f-link', 'options_html' => $tpl->getHtmlFrag('select-option', ['value_attr' => '0', 'label_text' => _NO, 'is_selected' => (string)($conf['comments']['link'] ?? '0') === '0']).$tpl->getHtmlFrag('select-option', ['value_attr' => '1', 'label_text' => _ANONIMP, 'is_selected' => (string)($conf['comments']['link'] ?? '0') === '1']).$tpl->getHtmlFrag('select-option', ['value_attr' => '2', 'label_text' => _ALLUSER, 'is_selected' => (string)($conf['comments']['link'] ?? '0') === '2'])])],
