...
function config(): void {
    ...
    $rows = [
        ...
        ['label_html' => $tpl->getHtmlFrag('label-hint', ['label' => _COMLETTER, 'hint' => _CONFINES]), 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'number', 'name_attr' => 'letter', 'value_attr' => (string)$conf['privat']['letter'], 'is_config' => true])],
        ['label_html' => $tpl->getHtmlFrag('label-hint', ['label' => _CSEND, 'hint' => _CONFINES]), 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'number', 'name_attr' => 'send', 'value_attr' => (string)$conf['privat']['send'], 'is_config' => true])],
        ['label_html' => $tpl->getHtmlFrag('label-hint', ['label' => _PRINM, 'hint' => _CONFINES]), 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'number', 'name_attr' => 'messin', 'value_attr' => (string)$conf['privat']['messin'], 'is_config' => true])],
        ['label_html' => $tpl->getHtmlFrag('label-hint', ['label' => _PRSAVEM, 'hint' => _CONFINES]), 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'number', 'name_attr' => 'messsav', 'value_attr' => (string)$conf['privat']['messsav'], 'is_config' => true])],
