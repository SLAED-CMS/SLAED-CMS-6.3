...
function config(): void {
    ...
    $rows = [
        ...
        ['label_for' => 'f-letter', 'label_html' => $tpl->getHtmlFrag('label-hint', ['label' => _COMLETTER, 'hint' => _CONFINES]), 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'number', 'name_attr' => 'letter', 'input_id' => 'f-letter', 'value_attr' => (string)$conf['privat']['letter'], 'is_config' => true])],
        ['label_for' => 'f-send', 'label_html' => $tpl->getHtmlFrag('label-hint', ['label' => _CSEND, 'hint' => _CONFINES]), 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'number', 'name_attr' => 'send', 'input_id' => 'f-send', 'value_attr' => (string)$conf['privat']['send'], 'is_config' => true])],
        ['label_for' => 'f-messin', 'label_html' => $tpl->getHtmlFrag('label-hint', ['label' => _PRINM, 'hint' => _CONFINES]), 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'number', 'name_attr' => 'messin', 'input_id' => 'f-messin', 'value_attr' => (string)$conf['privat']['messin'], 'is_config' => true])],
        ['label_for' => 'f-messsav', 'label_html' => $tpl->getHtmlFrag('label-hint', ['label' => _PRSAVEM, 'hint' => _CONFINES]), 'field_html' => $tpl->getHtmlFrag('input', ['itype' => 'number', 'name_attr' => 'messsav', 'input_id' => 'f-messsav', 'value_attr' => (string)$conf['privat']['messsav'], 'is_config' => true])],
