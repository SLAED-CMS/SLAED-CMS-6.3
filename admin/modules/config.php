...
function configNavi(int $opt = 0, int $tab = 0, int $subtab = 0, int $legacy = 0, string $id = ''): string {
    ...
    return getAdminTabs(_PREFERENCES, 'config.png', 'name=config', $ops, $lang, [], [], $tab, $subtab, $legacy, $id);
}
...
function save() {
    ...
    header("Location: ".$aroute.".php?name=config&op=show");
}
