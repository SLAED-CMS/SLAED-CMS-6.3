...
define('_SEC_STAT_DB','Dziennik operacji bazy danych');
define('_SEC_STAT_DMAP','Status skanowania plików');
define('_SEC_STAT_MON','Dziennik monitorowania');
...
define('_SCHEDULER_STATUS','Zadania schedulera');
define('_SCHEDULER_LAST_RUN','Ostatnie uruchomienie');
define('_SCHEDULER_LAST_OK','Ostatni sukces');
define('_SCHEDULER_NEXT_RUN','Nastepne uruchomienie');
define('_SCHEDULER_TRIGGER','Trigger');
define('_SCHEDULER_DURATION','Czas trwania');
define('_SCHEDULER_FAILS','Bledy');
define('_SCHEDULER_SCHEDULE','Harmonogram');
define('_SCHEDULER_HANDLER','Handler');
define('_SCHEDULER_SYSTEM','Systemowy');
define('_SCHEDULER_CUSTOM','Wlasny');
define('_SCHEDULER_PRIORITY','Priorytet');
define('_SCHEDULER_PRIORITY_INFO','Im mniejsza liczba, tym wczesniej zadanie zostanie uruchomione.');
define('_SCHEDULER_PRIORITY_DUP','Zadanie z takim priorytetem juz istnieje.');
...
define('_SCHEDULER_SAVED','Konfiguracja schedulera zapisana');
define('_SCHEDULER_DELETED','Zadanie schedulera usuniete');
define('_SCHEDULER_UNLOCKED','Blokada schedulera usunieta');
define('_SCHEDULER_RUNNING','Dziala');
define('_SCHEDULER_IDLE','Oczekuje');
define('_SCHEDULER_ADDJOB','Dodaj wlasne zadanie');
define('_SCHEDULER_EDITJOB','Edytuj zadanie');
define('_SCHEDULER_URL_INFO','Wzgledne URL sa rozwiazywane wzgledem adresu glownego strony');
define('_SCHEDULER_SYSTEM_INFO','Zadania systemowe mozna tutaj stroic przed usunieciem starych triggerow');
define('_SCHEDULER_SAVEERR','Uzupelnij wszystkie wymagane pola schedulera');
define('_SCHEDULER_MANUAL','Zezwol na reczny start');
define('_SCHEDULER_BATCH','Rozmiar partii');
define('_SCHEDULER_SCHEDULE_INFO','Format cron: minuta godzina dzien miesiac dzien_tygodnia. Przyklady: 0 2 * * * | 0 3 * * 1 | 15 1 1 * *');
