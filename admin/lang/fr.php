...
define('_SEC_STAT_DB','Journal des opérations de base de données');
define('_SEC_STAT_DMAP','Statut de l\'analyse des fichiers');
define('_SEC_STAT_MON','Journal de surveillance');
...
define('_SCHEDULER_STATUS','Taches du scheduler');
define('_SCHEDULER_LAST_RUN','Derniere execution');
define('_SCHEDULER_LAST_OK','Dernier succes');
define('_SCHEDULER_NEXT_RUN','Prochaine execution');
define('_SCHEDULER_TRIGGER','Declencheur');
define('_SCHEDULER_DURATION','Duree');
define('_SCHEDULER_FAILS','Echecs');
define('_SCHEDULER_SCHEDULE','Planification');
define('_SCHEDULER_HANDLER','Handler');
define('_SCHEDULER_SYSTEM','Systeme');
define('_SCHEDULER_CUSTOM','Personnalise');
define('_SCHEDULER_PRIORITY','Priorite');
define('_SCHEDULER_PRIORITY_INFO','Plus le nombre est petit, plus la tâche s'exécute tôt.');
define('_SCHEDULER_PRIORITY_DUP','Une tâche avec cette priorité existe déjà.');
...
define('_SCHEDULER_SAVED','Configuration du scheduler enregistree');
define('_SCHEDULER_DELETED','Tache du scheduler supprimee');
define('_SCHEDULER_UNLOCKED','Verrou du scheduler supprime');
define('_SCHEDULER_RUNNING','En cours');
define('_SCHEDULER_RESULT','Exécution');
define('_SCHEDULER_IDLE','En attente');
define('_SCHEDULER_ADDJOB','Ajouter une tache personnalisee');
define('_SCHEDULER_EDITJOB','Modifier la tache');
define('_SCHEDULER_URL_INFO','Les URL relatives sont resolues contre l URL de base du site');
define('_SCHEDULER_SYSTEM_INFO','Les taches systeme peuvent etre reglees ici avant la suppression des anciens triggers');
define('_SCHEDULER_SAVEERR','Veuillez remplir tous les champs requis du scheduler');
define('_SCHEDULER_MANUAL','Autoriser le demarrage manuel');
define('_SCHEDULER_BATCH','Taille du lot');
define('_SCHEDULER_SCHEDULE_INFO','Format cron : minute heure jour mois semaine. Exemples : 0 2 * * * | 0 3 * * 1 | 15 1 1 * *');
