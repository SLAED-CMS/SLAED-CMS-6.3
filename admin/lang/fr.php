...
define('_CACHEINFO','Gère aussi le cache du contenu analysé. La seconde option ne limite que le cache des pages, pas cette couche.');
define('_CACHEBROW','Durée du cache navigateur, en jours (0 - désactivé)');
...
define('_CACHETIME','Durée de vie du cache, en secondes');
define('_CACHETIMEINFO','Durée pendant laquelle une page construite et les paquets de styles et de scripts restent frais avant d\'être recréés. Le nettoyage planifié supprime les fichiers plus vieux que cette valeur multipliée par 24, jamais avant un jour.');
define('_CACHE_1','Page d\'accueil et listes des publications');
...
define('_CONFIG_BLOCKED','La restauration ne peut pas décider seule, raison : %s. Vérifiez manuellement les fichiers de l\'opération dans storage/backup/config.');
define('_CONFIG_CLEAN','Aucune opération de configuration interrompue n\'a été trouvée, la configuration est cohérente.');
define('_CONFIG_OP','Opération');
define('_CONFIG_PENDING','Une opération de configuration a été interrompue. Les nouveaux enregistrements de configuration sont refusés jusqu\'à sa restauration.');
define('_CONFIG_PHASE','Phase');
define('_CONFIG_RESTORE','Restaurer la configuration');
define('_CONFIG_RESTORED','La configuration a été restaurée avec succès.');
define('_CONFIG_VERDICT','Instantané à appliquer');
define('_NODE','Contenus');
define('_NODE_STALE','Le type Node %s a été modifié entre-temps par un autre enregistrement, rien n\'a été écrit. Rechargez la page et répétez la modification.');
...
define('_DIRDEF','Répertoire ouvert par défaut');
...
define('_FIELDINFO','Le nom technique d\'un champ et la clé d\'une option sont enregistrés avec chaque valeur et ne peuvent plus être modifiés ensuite : d\'abord une lettre latine minuscule, puis des lettres, des chiffres ou un tiret bas, 32 caractères au plus. Un titre qui commence par un tiret bas désigne une constante de langue. Les limites comptent les caractères d\'un texte, bornent un nombre ou une date, ou comptent les options choisies d\'une liste à plusieurs valeurs. Un champ désactivé est masqué et conserve ses valeurs ; un champ supprimé les perd au prochain enregistrement de leur propriétaire.');
define('_FIELDINPUT','Une ligne');
define('_FIELDS','Champs supplémentaires');
define('_FIELDS_BOOL','Interrupteur : oui ou non');
define('_FIELDS_INT','Nombre entier');
define('_FIELDS_DECIMAL','Nombre décimal');
define('_FIELDS_KEY','Nom technique');
define('_FIELDS_DEFAULT','Valeur par défaut');
define('_FIELDS_MULTI','Autoriser plusieurs valeurs');
define('_FIELDS_LOW','Limite inférieure');
define('_FIELDS_TOP','Limite supérieure');
define('_FIELDS_SCALE','Chiffres après la virgule');
define('_FIELDS_ITEMS','Options');
define('_FIELDS_NOMARK','La mise à jour des données 6.3 n\'a pas été exécutée : les champs supplémentaires sont fermés en écriture.');
define('_FIELDS_BAD','Les définitions ont été refusées, première erreur : %s');
...
define('_POINTS_DIFF','Modification du solde, avec signe');
define('_POINTS_NOTE','Motif de la modification');
define('_POINTS_BADDIFF','La modification du solde doit être un nombre entier de -1000000 à 1000000 différent de zéro, avec un motif.');
define('_POINTS_BADSAVE','Le solde n\'a pas été modifié : le système de points a refusé la correction.');
define('_POINTS_RESETMORE','La réinitialisation n\'est pas terminée. Envoyez à nouveau le formulaire pour continuer.');
define('_POINTS_JOURNAL','Journal des points');
define('_POINTS_NOMARK','La mise à jour des données 6.3 n\'a pas été exécutée : les points sont fermés en écriture.');
define('_POINTS_SOURCE','Source');
define('_POINTS_SCOPE','Contexte');
...
define('_RATINGS_GUESTS','Autoriser les invités à évaluer ?');
define('_RATINGS_NOMARK','La mise à jour des données 6.3 n\'a pas été exécutée : les évaluations sont fermées en écriture.');
define('_RATINGS_BADDAYS','L\'intervalle doit être un nombre entier de jours, zéro ou plus.');
define('_RATINGS_VOTES','Journal des évaluations');
define('_RATINGS_ANNUL','Annuler');
define('_RATINGS_REASON','Motif de l\'annulation');
define('_RATINGS_DONE','L\'évaluation est annulée.');
define('_RATINGS_ACTOR','Participant');
define('_RATINGS_TARGET','Cible');
...
define('_TPFORM','Formats de pièces jointes avec un modèle de sortie');
define('_TPFORMIN',"Pour quelles extensions l'onglet Modèles affiche un éditeur de modèle de sortie. Séparées par des virgules, sans point ni espace. Prises en charge :");
define('_TPHEIGHT','Hauteur par défaut de la pièce jointe, insérée dans [height]');
...
define('_TPWIDTH','Largeur par défaut de la pièce jointe, insérée dans [width]');
...
define('_SCHEDULER_LIMIT','Elements par execution');
