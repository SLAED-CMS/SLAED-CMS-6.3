...
define('_CAN','May');
define('_CAPKEY','Site Key');
define('_CAPKEYI','We recommend installing your own, you can get the key for free on this website: https://www.google.com/recaptcha/admin');
define('_CAPQUALITY','The quality of verification for a real user');
define('_CAPQUALITYI','The higher the value, the higher the likelihood that the request is sent by a real person.');
define('_CAPSEC0','Do not use');
define('_CAPSEC1','When authorizing an administrator');
define('_CAPSEC2','When authorizing a user');
define('_CAPSEC3','When registering a new user');
define('_CAPSEC4','Together, when registering and when authorizing a user');
define('_CAPSEC5','Administrator and user authorization');
define('_CAPSEC6','Administrator and new user registration');
define('_CAPSEC7','Always, for administrator and user');
define('_CAPSECKEY','The secret key');
define('_CAPTCHA','Protection against spam bots, works in the background');
...
define('_SEC_STAT_DB','Database operations log');
define('_SEC_STAT_DMAP','File scan status');
define('_SEC_STAT_MON','Monitor log');
...
define('_SCHEDULER_LAST_RUN','Last run');
define('_SCHEDULER_LAST_OK','Last success');
define('_SCHEDULER_NEXT_RUN','Next run');
define('_SCHEDULER_TRIGGER','Trigger');
define('_SCHEDULER_DURATION','Duration');
define('_SCHEDULER_FAILS','Fails');
define('_SCHEDULER_SCHEDULE','Schedule');
define('_SCHEDULER_HANDLER','Handler');
define('_SCHEDULER_SYSTEM','System');
define('_SCHEDULER_CUSTOM','Custom');
define('_SCHEDULER_PRIORITY','Priority');
define('_SCHEDULER_PRIORITY_INFO','The lower the number, the earlier the job runs.');
define('_SCHEDULER_PRIORITY_DUP','A job with this priority already exists.');
...
define('_SCHEDULER_SAVED','Scheduler configuration saved');
define('_SCHEDULER_DELETED','Scheduler job deleted');
define('_SCHEDULER_UNLOCKED','Scheduler lock cleared');
define('_SCHEDULER_RUNNING','Running');
define('_SCHEDULER_RESULT','Execution');
define('_SCHEDULER_IDLE','Idle');
define('_SCHEDULER_ADDJOB','Add custom job');
define('_SCHEDULER_EDITJOB','Edit job');
define('_SCHEDULER_URL_INFO','Relative URLs are resolved against the site home URL');
define('_SCHEDULER_SYSTEM_INFO','System jobs can be tuned here and later migrated away from legacy triggers');
define('_SCHEDULER_SAVEERR','Please fill all required scheduler fields');
define('_SCHEDULER_MANUAL','Allow manual start');
define('_SCHEDULER_BATCH','Batch size');
define('_SCHEDULER_SCHEDULE_INFO','Cron format: minute hour day month weekday. Examples: 0 2 * * * | 0 3 * * 1 | 15 1 1 * *');
