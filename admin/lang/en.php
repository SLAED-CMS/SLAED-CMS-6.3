...
define('_NLSENDI','When sending emails, the scheduler manages this setting automatically — it enables and disables it on its own. Manual changes are usually not required.');
