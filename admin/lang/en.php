...
define('_CAN','May');
define('_CATDRAGSORT','Reorder categories by dragging the grip — only among siblings of the same parent within their module. Subcategories move together with their parent. Click a module header to collapse its group.');
...
define('_DRAGSORT','Reorder blocks by dragging the grip in the "Position" column — only within their group. Free blocks are collected in a separate group and are output with the [block=id] tag; position and order do not apply to them.');
