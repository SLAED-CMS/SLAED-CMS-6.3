...
define('_CAN','Можуть');
define('_CATDRAGSORT','Порядок категорій змінюється перетягуванням за ручку — лише серед сусідів одного батька всередині свого модуля. Підкатегорії переїжджають разом із батьком. Клік по заголовку модуля згортає групу.');
...
define('_DRAGSORT','Порядок блоків змінюється перетягуванням за ручку в колонці «Позиція» — лише всередині своєї групи. Вільні блоки зібрані в окремій групі, виводяться тегом [block=id], позиція та порядок на них не діють.');
