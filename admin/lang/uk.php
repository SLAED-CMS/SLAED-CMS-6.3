...
define('_SEC_STAT_DB','Журнал операцій з базою даних');
define('_SEC_STAT_DMAP','Статус сканування файлів');
define('_SEC_STAT_MON','Журнал моніторингу');
...
define('_SCHEDULER_STATUS','Завдання планувальника');
define('_SCHEDULER_LAST_RUN','Останній запуск');
define('_SCHEDULER_LAST_OK','Останній успіх');
define('_SCHEDULER_NEXT_RUN','Наступний запуск');
define('_SCHEDULER_TRIGGER','Тригер');
define('_SCHEDULER_DURATION','Тривалість');
define('_SCHEDULER_FAILS','Помилки');
define('_SCHEDULER_SCHEDULE','Розклад');
define('_SCHEDULER_HANDLER','Обробник');
define('_SCHEDULER_SYSTEM','Системний');
define('_SCHEDULER_CUSTOM','Користувацький');
define('_SCHEDULER_PRIORITY','Пріоритет');
define('_SCHEDULER_PRIORITY_INFO','Чим менше число, тим раніше буде запуск.');
define('_SCHEDULER_PRIORITY_DUP','Завдання з таким пріоритетом вже існує.');
...
define('_SCHEDULER_SAVED','Конфігурацію планувальника збережено');
define('_SCHEDULER_DELETED','Завдання планувальника видалено');
define('_SCHEDULER_UNLOCKED','Блокування планувальника знято');
define('_SCHEDULER_RUNNING','Виконується');
define('_SCHEDULER_RESULT','Виконання');
define('_SCHEDULER_IDLE','Очікує');
define('_SCHEDULER_ADDJOB','Додати користувацьке завдання');
define('_SCHEDULER_EDITJOB','Редагувати завдання');
define('_SCHEDULER_URL_INFO','Відносні URL буде розв язано від домашнього URL сайту');
define('_SCHEDULER_SYSTEM_INFO','Системні завдання можна налаштовувати тут до видалення старих тригерів');
define('_SCHEDULER_SAVEERR','Заповніть усі обов язкові поля планувальника');
define('_SCHEDULER_MANUAL','Дозволити ручний запуск');
define('_SCHEDULER_BATCH','Розмір пакета');
define('_SCHEDULER_SCHEDULE_INFO','Формат cron: хвилина година день місяць день_тижня. Приклади: 0 2 * * * | 0 3 * * 1 | 15 1 1 * *');
