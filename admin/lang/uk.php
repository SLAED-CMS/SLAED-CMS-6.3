...
define('_SCHEDULER_STATUS_INFO','Поточний стан виконання з автоматичним оновленням HTMX');
...
define('_SCHEDULER_LOCK','Таймаут блокування');
...
define('_SCHEDULER_MANUAL','Ручний запуск');
