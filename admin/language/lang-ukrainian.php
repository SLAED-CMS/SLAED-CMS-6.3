...
efine('_OPTTEXT','Оптимізація виконує перебудову таблиць та оновлює внутрішню статистику, що інколи може покращити продуктивність. Для сучасних таблиць InnoDB таку операцію варто виконувати лише після значних змін (наприклад масового видалення), а не регулярно.');
...
define("_SEC_AUTH_OK","Додаткові пароль і логін благополучно встановлені. Для відключення або зміни пароля і логіна відкрийте файл: config/config_security.php і змініть значення змінних на: 'login' => '' та 'password' => ''");
