...
define("_LANGKEYI","Рекомендуємо встановити свій, отримати ключ безкоштовно можна на даному сайті: https://translate.yandex.ru/developers/keys");
...
define("_SEC_AUTH_OK","Додаткові пароль і логін благополучно встановлені. Для відключення або зміни пароля і логіна відкрийте файл: config/security.php і змініть значення змінних на: 'login' => '' та 'password' => ''");
...
define("_SKDWORDS","Виключити такі слова з ключових слів сайту");
define("_KEY_SEP","Розділяти ключові слова комами?");
